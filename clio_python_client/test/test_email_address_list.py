...
class TestEmailAddressList(unittest.TestCase):
    """EmailAddressList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailAddressList:
        """Test EmailAddressList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailAddressList`
        """
        model = EmailAddressList()
        if include_optional:
