...
class DocumentAutomationCreateRequestData(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "document_template": DocumentAutomationCreateRequestDataDocumentTemplate.from_dict(obj["document_template"]) if obj.get("document_template") is not None else None,
            "filename": obj.get("filename"),
            "formats": obj.get("formats"),
            "matter": DocumentAutomationCreateRequestDataMatter.from_dict(obj["matter"]) if obj.get("matter") is not None else None
        })
        return _obj
