...
from clio_client.openapi_client.models.task_template_list_copy_request_data_practice_area import (
...
class TaskTemplateListCopyRequestData(BaseModel):
    ...
    """ # noqa: E501
    description: StrictStr | None = Field(default=None, description="The description of the TaskTemplateList copy.")
    name: StrictStr | None = Field(default=None, description="The name of the TaskTemplateList copy.")
    practice_area: TaskTemplateListCopyRequestDataPracticeArea | None = None
    __properties: ClassVar[list[str]] = ["description", "name", "practice_area"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "practice_area": TaskTemplateListCopyRequestDataPracticeArea.from_dict(obj["practice_area"]) if obj.get("practice_area") is not None else None
        })
        return _obj
