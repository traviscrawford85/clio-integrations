...
from clio_client.openapi_client.models.document_category import \
    DocumentCategory
...
class DocumentCategoryList(BaseModel):
    ...
    """ # noqa: E501
    data: List[DocumentCategory] = Field(description="DocumentCategory List Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DocumentCategory.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
