...
class BillUpdateRequestDataInterest(BaseModel):
    ...
    """ # noqa: E501
    rate: StrictFloat | StrictInt | None = Field(default=None, description="Interest amount for the Bill as percentage.")
    type: StrictStr | None = Field(default=None, description="The type of interest you are applying to your Bill with the `interest[rate]`.")
    period: StrictInt | None = Field(default=None, description="The interest period for how frequently your Bill will charge interest.")
    __properties: ClassVar[list[str]] = ["rate", "type", "period"]
