...
from clio_client.openapi_client.models.task_update_request_data import (
...
class TaskUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": TaskUpdateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
