...
from clio_client.openapi_client.models.custom_field_create_request_data_picklist_options_inner import (
...
class CustomFieldCreateRequestData(BaseModel):
    ...
    displayed: StrictBool | None = Field(default=True, description="Whether or not the CustomField should be displayed by default.")
    field_type: StrictStr = Field(description="Field type of the CustomField.")
    name: StrictStr = Field(description="CustomField name.")
    parent_type: StrictStr = Field(description="Type of object the CustomField is for.")
    picklist_options: list[CustomFieldCreateRequestDataPicklistOptionsInner] | None = None
    required: StrictBool | None = Field(default=False, description="Whether or not the CustomField should require a value.")
    __properties: ClassVar[list[str]] = ["display_order", "displayed", "field_type", "name", "parent_type", "picklist_options", "required"]
    ...
    def parent_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Contact', 'Matter']):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.picklist_options:
            for _item_picklist_options in self.picklist_options:
                if _item_picklist_options:
                    _items.append(_item_picklist_options.to_dict())
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "picklist_options": [CustomFieldCreateRequestDataPicklistOptionsInner.from_dict(_item) for _item in obj["picklist_options"]] if obj.get("picklist_options") is not None else None,
