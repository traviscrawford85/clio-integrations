...
class AvatarBase(BaseModel):
    ...
    AvatarBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *Avatar*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *Avatar*")
    created_at: datetime | None = Field(default=None, description="The time the *Avatar* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *Avatar* was last updated (as a ISO-8601 timestamp)")
    url: StrictStr | None = Field(default=None, description="The URL for the *Avatar*")
    destroy: StrictBool | None = Field(default=None, description="Whether to destroy the *Avatar*", alias="_destroy")
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at", "url", "_destroy"]
