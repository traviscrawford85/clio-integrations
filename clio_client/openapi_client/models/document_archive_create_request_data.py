...
from clio_client.openapi_client.models.document_archive_create_request_data_items_inner import (
...
class DocumentArchiveCreateRequestData(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "items": [DocumentArchiveCreateRequestDataItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
