...
class MedicalRecordsRequestUpdateRequestDataMedicalBillsInner(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "payers": [MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner.from_dict(_item) for _item in obj["payers"]] if obj.get("payers") is not None else None
        })
        return _obj
