...
class AccountBalanceBase(BaseModel):
    ...
    AccountBalanceBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *AccountBalance*")
    balance: StrictFloat | StrictInt | None = Field(default=None, description="The current balance of the bank account available to the matter or contact")
    type: StrictStr | None = Field(default=None, description="The bank account type. Either Operating or Trust")
    name: StrictStr | None = Field(default=None, description="The name of the bank account")
    __properties: ClassVar[list[str]] = ["id", "balance", "type", "name"]
