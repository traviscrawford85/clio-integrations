...
class OutstandingClientBalance(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.outstanding_bills:
            for _item_outstanding_bills in self.outstanding_bills:
                if _item_outstanding_bills:
                    _items.append(_item_outstanding_bills.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outstanding_bills": [BillBase.from_dict(_item) for _item in obj["outstanding_bills"]] if obj.get("outstanding_bills") is not None else None,
