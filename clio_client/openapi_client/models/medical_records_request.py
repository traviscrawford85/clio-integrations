...
from clio_client.openapi_client.models.medical_record_base import \
    MedicalRecordBase
...
class MedicalRecordsRequest(BaseModel):
    ...
    medical_bills: Optional[List[MedicalBillBase]] = Field(default=None, description="MedicalBill")
    medical_records: Optional[List[MedicalRecordBase]] = Field(default=None, description="MedicalRecord")
