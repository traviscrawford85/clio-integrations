...
from clio_client.openapi_client.models.conversation_message_create_request_data_attachment import (
    ConversationMessageCreateRequestDataAttachment,
)
from clio_client.openapi_client.models.conversation_message_create_request_data_conversation import (
    ConversationMessageCreateRequestDataConversation,
)
from clio_client.openapi_client.models.conversation_message_create_request_data_matter import (
    ConversationMessageCreateRequestDataMatter,
)
from clio_client.openapi_client.models.conversation_message_create_request_data_receivers_inner import (
...
class ConversationMessageCreateRequestData(BaseModel):
    ...
    """ # noqa: E501
    attachment: ConversationMessageCreateRequestDataAttachment | None = None
    body: StrictStr = Field(description="The body value.")
    conversation: ConversationMessageCreateRequestDataConversation | None = None
    matter: ConversationMessageCreateRequestDataMatter | None = None
    receivers: list[ConversationMessageCreateRequestDataReceiversInner]
    subject: StrictStr = Field(description="The subject value.")
    __properties: ClassVar[list[str]] = ["attachment", "body", "conversation", "matter", "receivers", "subject"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "attachment": ConversationMessageCreateRequestDataAttachment.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None,
            "body": obj.get("body"),
            "conversation": ConversationMessageCreateRequestDataConversation.from_dict(obj["conversation"]) if obj.get("conversation") is not None else None,
            "matter": ConversationMessageCreateRequestDataMatter.from_dict(obj["matter"]) if obj.get("matter") is not None else None,
            "receivers": [ConversationMessageCreateRequestDataReceiversInner.from_dict(_item) for _item in obj["receivers"]] if obj.get("receivers") is not None else None,
