...
class CustomFieldCreateRequestDataPicklistOptionsInner(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single PicklistOption associated with the CustomField. The keyword `null` is not valid for this field. Not required for creating new PicklistOptions, but required for updating or deleting existing ones.")
    option: StrictStr | None = Field(default=None, description="The option value.")
    deleted: StrictBool | None = Field(default=None, description="Whether or not the PicklistOption should be deleted.", alias="_deleted")
    __properties: ClassVar[list[str]] = ["id", "option", "_deleted"]
