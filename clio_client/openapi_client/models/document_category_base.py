...
class DocumentCategoryBase(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *DocumentCategory*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *DocumentCategory*")
    name: StrictStr | None = Field(default=None, description="The name of the *DocumentCategory*")
    created_at: datetime | None = Field(default=None, description="The time the *DocumentCategory* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *DocumentCategory* was last updated (as a ISO-8601 timestamp)")
