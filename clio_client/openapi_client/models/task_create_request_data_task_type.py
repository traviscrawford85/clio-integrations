...
class TaskCreateRequestDataTaskType(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single TaskType associated with the Task. The keyword `null` is not valid for this field.")
