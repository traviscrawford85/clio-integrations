...
class ActivityDescriptionUpdateRequestDataGroupsInner(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single Group associated with the ActivityDescription. The keyword `null` is not valid for this field.")
    deleted: StrictBool | None = Field(default=None, description="A flag to determine if this Group should lose access to this ActivityDescription.", alias="_deleted")
    __properties: ClassVar[list[str]] = ["id", "_deleted"]
