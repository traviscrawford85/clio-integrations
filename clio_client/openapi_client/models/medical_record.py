...
class MedicalRecord(BaseModel):
    ...
    MedicalRecord
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *MedicalRecord*")
    document_id: StrictInt | None = Field(default=None, description="The id of the document associated with the Medical Record")
    etag: StrictStr | None = Field(default=None, description="ETag for the *MedicalRecord*")
    end_date: datetime | None = Field(default=None, description="End date for *MedicalRecord* (as a ISO-8601 date)")
    start_date: datetime | None = Field(default=None, description="Start date for *MedicalRecord* (as a ISO-8601 date)")
    created_at: datetime | None = Field(default=None, description="The time the *MedicalRecord* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *MedicalRecord* was last updated (as a ISO-8601 timestamp)")
    matter: MatterBase | None = None
    __properties: ClassVar[list[str]] = ["id", "document_id", "etag", "end_date", "start_date", "created_at", "updated_at", "matter"]
