...
class Payment(BaseModel):
    ...
    Payment
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *Payment*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *Payment*")
    description: StrictStr | None = Field(default=None, description="A detailed description of the *Payment*")
    reference: StrictStr | None = Field(default=None, description="A reference for the payment")
    amount: StrictFloat | StrictInt | None = Field(default=None, description="Total amount paid. The default is 0.00.")
    var_date: date | None = Field(default=None, description="The date the *Payment* was recorded (as a ISO-8601 date)", alias="date")
    source_fund_type: StrictStr | None = Field(default=None, description="The fund type for *Payment* source")
    voided_at: datetime | None = Field(default=None, description="Time the *Payment* was voided (as a ISO-8601 timestamp)")
    created_at: datetime | None = Field(default=None, description="The time the *Payment* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *Payment* was last updated (as a ISO-8601 timestamp)")
    ...
    __properties: ClassVar[list[str]] = ["id", "etag", "description", "reference", "amount", "date", "source_fund_type", "voided_at", "created_at", "updated_at", "contact", "user", "source_bank_account", "destination_bank_account", "allocations"]

    @field_validator('source_fund_type')
    def source_fund_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['Client', 'Matter']):
