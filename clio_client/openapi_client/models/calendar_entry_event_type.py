...
class CalendarEntryEventType(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *CalendarEntryEventType*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *CalendarEntryEventType*")
    created_at: datetime | None = Field(default=None, description="The time the *CalendarEntryEventType* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *CalendarEntryEventType* was last updated (as a ISO-8601 timestamp)")
    color: StrictStr | None = Field(default=None, description="The color describing the *CalendarEntryEventType*")
    name: StrictStr | None = Field(default=None, description="The name for the *CalendarEntryEventType*")
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at", "color", "name"]
