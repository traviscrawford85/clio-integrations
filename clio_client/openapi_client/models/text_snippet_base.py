...
class TextSnippetBase(BaseModel):
    ...
    TextSnippetBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *TextSnippet*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *TextSnippet*")
    created_at: datetime | None = Field(default=None, description="The time the *TextSnippet* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *TextSnippet* was last updated (as a ISO-8601 timestamp)")
    snippet: StrictStr | None = Field(default=None, description="The abbreviation that should be expanded")
    phrase: StrictStr | None = Field(default=None, description="The phrase the abbreviation should be expanded to")
    whole_word: StrictBool | None = Field(default=None, description="Whether the *TextSnippet* abbreviation requires a space after it has been entered to expand to a phrase")
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at", "snippet", "phrase", "whole_word"]
