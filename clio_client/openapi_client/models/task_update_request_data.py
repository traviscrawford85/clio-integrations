...
from clio_client.openapi_client.models.task_update_request_data_assignee import (
...
class TaskUpdateRequestData(BaseModel):
    ...
    """ # noqa: E501
    assignee: TaskUpdateRequestDataAssignee | None = None
    ...
    description: StrictStr | None = Field(default=None, description="Longer description of the Task.")
    ...
    __properties: ClassVar[list[str]] = ["assignee", "cascading", "cascading_offset", "cascading_offset_polarity", "cascading_offset_type", "cascading_source", "description", "due_at", "matter", "name", "notify_assignee", "notify_completion", "permission", "priority", "status", "task_type", "time_estimated"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "assignee": TaskUpdateRequestDataAssignee.from_dict(obj["assignee"]) if obj.get("assignee") is not None else None,
