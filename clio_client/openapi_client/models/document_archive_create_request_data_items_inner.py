...
class DocumentArchiveCreateRequestDataItemsInner(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for a single Document or Folder associated with the DocumentArchive. Use the keyword `null` to specify no association.")
    type: StrictInt = Field(description="The type of the item to download")
