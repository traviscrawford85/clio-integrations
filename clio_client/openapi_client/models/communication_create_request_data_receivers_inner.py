...
class CommunicationCreateRequestDataReceiversInner(BaseModel):
    ...
    """ # noqa: E501
    deleted: StrictBool | None = Field(default=None, description="Whether or not the receivers should be deleted.", alias="_deleted")
    id: StrictInt | None = Field(default=None, description="Unique ids for the receivers of this Communication.")
    type: StrictStr | None = Field(default=None, description="Types of the receivers of this Communication.")
    __properties: ClassVar[list[str]] = ["_deleted", "id", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['User', 'Contact']):
