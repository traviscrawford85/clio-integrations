...
class ClientPortalBase(BaseModel):
    ...
    ClientPortalBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *ClientPortal*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *ClientPortal*")
    created_at: datetime | None = Field(default=None, description="The time the *ClientPortal* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *ClientPortal* was last updated (as a ISO-8601 timestamp)")
    unread_count: StrictInt | None = Field(default=None, description="The number of unread count messages for the current user.")
    unread_notifiable_count: StrictInt | None = Field(default=None, description="The number of unread messages for the current user once their notification settings have been applied.")
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at", "unread_count", "unread_notifiable_count"]
