...
class ExpenseCategoryCreateRequestDataUtbmsCode(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single UtbmsCode associated with the ExpenseCategory. The keyword `null` is not valid for this field.")
