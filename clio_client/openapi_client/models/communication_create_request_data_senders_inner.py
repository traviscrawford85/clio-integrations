...
class CommunicationCreateRequestDataSendersInner(BaseModel):
    ...
    """ # noqa: E501
    deleted: StrictBool | None = Field(default=None, description="Whether or not the senders should be deleted.", alias="_deleted")
    id: StrictInt | None = Field(default=None, description="Unique ids for the senders of this Communication.")
    type: StrictStr | None = Field(default=None, description="Types of the senders of this Communication.")
