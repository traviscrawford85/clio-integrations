...
class Reminder(BaseModel):
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['initializing', 'scheduling', 'rescheduling', 'scheduled', 'attempting_delivery', 'delivery_failed', 'delivered', 'delivery_skipped', 'invalid_user']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notification_method": NotificationMethodBase.from_dict(obj["notification_method"]) if obj.get("notification_method") is not None else None,
