...
class DocumentTemplate(BaseModel):
    ...
    DocumentTemplate
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *DocumentTemplate*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *DocumentTemplate*")
    size: StrictInt | None = Field(default=None, description="The size in bytes of the template")
    content_type: StrictStr | None = Field(default=None, description="A standard MIME type describing the format of the object data.")
    filename: StrictStr | None = Field(default=None, description="The name of the original file that was uploaded")
    created_at: datetime | None = Field(default=None, description="The time the *DocumentTemplate* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *DocumentTemplate* was last updated (as a ISO-8601 timestamp)")
    document_category: DocumentCategoryBase | None = None
    last_modified_by: UserBase | None = None
    __properties: ClassVar[list[str]] = ["id", "etag", "size", "content_type", "filename", "created_at", "updated_at", "document_category", "last_modified_by"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "last_modified_by": UserBase.from_dict(obj["last_modified_by"]) if obj.get("last_modified_by") is not None else None
        })
        return _obj
