...
class EventBase(BaseModel):
    ...
    EventBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *Event*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *Event*")
    message: StrictStr | None = Field(default=None, description="Concise headline message describing the event")
    icon: StrictStr | None = Field(default=None, description="Font Awesome icon to display (without the fa- prefix)")
    title: StrictStr | None = Field(default=None, description="The title or subject of the event (e.g. Matter Number, Document Title)")
    title_url: StrictStr | None = Field(default=None, description="Target URL that will be opened if the user clicks on the event title")
    description: StrictStr | None = Field(default=None, description="Description or additional information about the event (e.g. Matter Description)")
    description_url: StrictStr | None = Field(default=None, description="Target URL that will be opened if the user clicks on the event description")
    primary_detail: StrictStr | None = Field(default=None, description="Optional additional information about the event (e.g. Matter Client, Document Author)")
    primary_detail_url: StrictStr | None = Field(default=None, description="Target URL that will be opened if the user clicks on the primary detail")
    secondary_detail: StrictStr | None = Field(default=None, description="Optional additional information about the event (e.g. Matter Status, Document Size)")
    secondary_detail_url: StrictStr | None = Field(default=None, description="Target URL that will be opened if the user clicks on the secondary detail")
    occurred_at: datetime | None = Field(default=None, description="When the event occurred")
    mobile_icon: StrictStr | None = Field(default=None, description="Icon to be displayed in the mobile app")
    subject_type: StrictStr | None = Field(default=None, description="The type of subject that triggered the notification (e.g. Matter, Document)")
    subject_id: StrictInt | None = Field(default=None, description="Id of the subject that triggered the notification")
    __properties: ClassVar[list[str]] = ["id", "etag", "message", "icon", "title", "title_url", "description", "description_url", "primary_detail", "primary_detail_url", "secondary_detail", "secondary_detail_url", "occurred_at", "mobile_icon", "subject_type", "subject_id"]
