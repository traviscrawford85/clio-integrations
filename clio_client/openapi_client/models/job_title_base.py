...
class JobTitleBase(BaseModel):
    ...
    JobTitleBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *JobTitle*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *JobTitle*")
    name: StrictStr | None = Field(default=None, description="Name of the job title")
    initials: StrictStr | None = Field(default=None, description="Initials of the job title")
    __properties: ClassVar[list[str]] = ["id", "etag", "name", "initials"]
