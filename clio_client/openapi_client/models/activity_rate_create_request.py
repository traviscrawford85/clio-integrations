...
from clio_client.openapi_client.models.activity_rate_create_request_data import (
...
class ActivityRateCreateRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": ActivityRateCreateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
