...
class CalendarVisibility(BaseModel):
    ...
    CalendarVisibility
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *CalendarVisibility*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *CalendarVisibility*")
    color: StrictStr | None = Field(default=None, description="Calendar color")
    light_color: StrictStr | None = Field(default=None, description="Accent color to complement the main calendar color.")
    visible: StrictBool | None = Field(default=None, description="Whether the *CalendarVisibility* will be shown by default in the Clio Web UI.")
    name: StrictStr | None = Field(default=None, description="Calendar name")
    created_at: datetime | None = Field(default=None, description="The time the *CalendarVisibility* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *CalendarVisibility* was last updated (as a ISO-8601 timestamp)")
