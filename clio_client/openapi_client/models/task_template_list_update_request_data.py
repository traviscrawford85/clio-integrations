...
from clio_client.openapi_client.models.task_template_list_create_request_data_practice_area import (
...
class TaskTemplateListUpdateRequestData(BaseModel):
    ...
    """ # noqa: E501
    description: StrictStr | None = Field(default=None, description="Description of the TaskTemplateList.")
    name: StrictStr | None = Field(default=None, description="Name of the TaskTemplateList.")
    practice_area: TaskTemplateListCreateRequestDataPracticeArea | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "practice_area": TaskTemplateListCreateRequestDataPracticeArea.from_dict(obj["practice_area"]) if obj.get("practice_area") is not None else None
        })
        return _obj
