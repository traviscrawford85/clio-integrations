...
from clio_client.openapi_client.models.matter_create_request_data_relationships_inner_contact import (
...
class MatterCreateRequestDataRelationshipsInner(BaseModel):
    ...
    """ # noqa: E501
    description: StrictStr = Field(description="Describe the relationship between a Contact and a Matter.")
    contact: MatterCreateRequestDataRelationshipsInnerContact
    __properties: ClassVar[list[str]] = ["description", "contact"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "contact": MatterCreateRequestDataRelationshipsInnerContact.from_dict(obj["contact"]) if obj.get("contact") is not None else None
        })
        return _obj
