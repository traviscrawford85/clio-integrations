...
class ContactUpdateRequestDataWebSitesInner(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr | None = Field(default='Other', description="Name of the WebSite.")
    address: StrictStr | None = Field(default=None, description="URL of the WebSite.")
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single WebSite associated with the Contact. The keyword `null` is not valid for this field.")
    default_web_site: StrictBool | None = Field(default=None, description="Whether or not the Contact should be the default website for the Contact.")
    destroy: StrictBool | None = Field(default=None, description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated WebSite is present, the WebSite is deleted from the Contact.", alias="_destroy")
    __properties: ClassVar[list[str]] = ["name", "address", "id", "default_web_site", "_destroy"]
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in set(['Work', 'Personal', 'Twitter', 'Facebook', 'LinkedIn', 'Instant Messenger', 'Other']):
