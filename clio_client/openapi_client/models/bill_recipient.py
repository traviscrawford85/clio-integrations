...
from clio_client.openapi_client.models.bill_recipient_contact_base import (
...
class BillRecipient(BaseModel):
    ...
    BillRecipient
    """ # noqa: E501
    created_at: datetime | None = Field(default=None, description="The time the *BillRecipient* was created (as a ISO-8601 timestamp)")
    etag: StrictStr | None = Field(default=None, description="ETag for the *BillRecipient*")
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *BillRecipient*")
    on_all_matters: StrictBool | None = Field(default=None, description="If the associated contact is a recipient for all of the bill's matters")
    updated_at: datetime | None = Field(default=None, description="The time the *BillRecipient* was updated (as a ISO-8601 timestamp)")
    recipient: BillRecipientContactBase | None = None
    __properties: ClassVar[list[str]] = ["created_at", "etag", "id", "on_all_matters", "updated_at", "recipient"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "recipient": BillRecipientContactBase.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None
        })
        return _obj
