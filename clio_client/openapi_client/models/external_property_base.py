...
class ExternalPropertyBase(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *ExternalProperty*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *ExternalProperty*")
    name: StrictStr | None = Field(default=None, description="The name of the *ExternalProperty*")
    value: StrictStr | None = Field(default=None, description="The value of the *ExternalProperty*")
    created_at: datetime | None = Field(default=None, description="The time the *ExternalProperty* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *ExternalProperty* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "name", "value", "created_at", "updated_at"]
