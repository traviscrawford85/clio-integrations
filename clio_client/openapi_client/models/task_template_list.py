...
class TaskTemplateList(BaseModel):
    ...
    TaskTemplateList
    """ # noqa: E501
    data: list[TaskTemplate] = Field(description="TaskTemplate List Response")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": [TaskTemplate.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
