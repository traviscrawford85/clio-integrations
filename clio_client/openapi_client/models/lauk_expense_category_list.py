...
from clio_client.openapi_client.models.lauk_expense_category import \
    LaukExpenseCategory
...
class LaukExpenseCategoryList(BaseModel):
    ...
    """ # noqa: E501
    data: List[LaukExpenseCategory] = Field(description="LaukExpenseCategory List Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [LaukExpenseCategory.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
