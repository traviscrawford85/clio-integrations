...
from clio_client.openapi_client.models.activity_description_update_request_data_groups_inner import (
...
class ActivityDescriptionUpdateRequestData(BaseModel):
    ...
    groups: list[ActivityDescriptionUpdateRequestDataGroupsInner] | None = None
    name: StrictStr | None = Field(default=None, description="A detailed description of the ActivityDescription.")
