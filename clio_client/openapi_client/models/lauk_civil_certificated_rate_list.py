...
from clio_client.openapi_client.models.lauk_civil_certificated_rate import (
...
class LaukCivilCertificatedRateList(BaseModel):
    ...
    """ # noqa: E501
    data: list[LaukCivilCertificatedRate] = Field(description="LaukCivilCertificatedRate List Response")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": [LaukCivilCertificatedRate.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
