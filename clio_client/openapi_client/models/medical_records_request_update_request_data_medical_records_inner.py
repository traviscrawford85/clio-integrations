...
class MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner(BaseModel):
    ...
    """ # noqa: E501
    document_id: StrictInt | None = Field(default=None, description="The unique identifier for a single MedicalRecord associated with the MedicalRecordsRequest. The keyword `null` is not valid for this field.")
    end_date: datetime | None = Field(default=None, description="End date for Medical Record.")
    start_date: datetime | None = Field(default=None, description="Start date for Medical Record.")
    __properties: ClassVar[list[str]] = ["document_id", "end_date", "start_date"]
