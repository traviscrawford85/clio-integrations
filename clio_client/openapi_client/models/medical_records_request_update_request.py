...
from clio_client.openapi_client.models.medical_records_request_update_request_data import (
...
class MedicalRecordsRequestUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": MedicalRecordsRequestUpdateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
