...
class BillTheme(BaseModel):
    ...
    BillTheme
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *BillTheme*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *BillTheme*")
    created_at: datetime | None = Field(default=None, description="The time the *BillTheme* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *BillTheme* was last updated (as a ISO-8601 timestamp)")
    account_id: StrictInt | None = Field(default=None, description="The account number the *BillTheme* belongs to")
    default: StrictBool | None = Field(default=None, description="Whether the *BillTheme* is the default for its account")
    name: StrictStr | None = Field(default=None, description="The name of the *BillTheme*")
    config: StrictStr | None = Field(default=None, description="The configuration of the *BillTheme*")
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at", "account_id", "default", "name", "config"]
