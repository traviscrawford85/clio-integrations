...
class FolderUpdateRequestData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "external_properties": [FolderUpdateRequestDataExternalPropertiesInner.from_dict(_item) for _item in obj["external_properties"]] if obj.get("external_properties") is not None else None,
            "name": obj.get("name"),
            "parent": FolderUpdateRequestDataParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
