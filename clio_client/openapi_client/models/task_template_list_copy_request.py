...
from clio_client.openapi_client.models.task_template_list_copy_request_data import (
...
class TaskTemplateListCopyRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": TaskTemplateListCopyRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
