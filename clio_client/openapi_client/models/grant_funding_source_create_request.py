...
from clio_client.openapi_client.models.grant_funding_source_create_request_data import \
...
class GrantFundingSourceCreateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GrantFundingSourceCreateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
