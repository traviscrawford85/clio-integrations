...
class Calendar(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "etag", "color", "light_color", "court_rules_default_calendar", "name", "permission", "type", "visible", "created_at", "updated_at", "source", "creator"]
