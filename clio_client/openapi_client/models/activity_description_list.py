...
from clio_client.openapi_client.models.activity_description import \
    ActivityDescription
...
class ActivityDescriptionList(BaseModel):
    ...
    """ # noqa: E501
    data: List[ActivityDescription] = Field(description="ActivityDescription List Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ActivityDescription.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
