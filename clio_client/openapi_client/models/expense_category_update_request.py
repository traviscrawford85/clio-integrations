...
from clio_client.openapi_client.models.expense_category_update_request_data import \
...
class ExpenseCategoryUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ExpenseCategoryUpdateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
