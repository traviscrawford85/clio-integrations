...
class TaskTemplateCreateRequestDataCascadingSource(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single TaskTemplate associated with the TaskTemplate. The keyword `null` is not valid for this field.")
