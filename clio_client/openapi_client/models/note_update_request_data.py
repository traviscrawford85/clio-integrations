...
from clio_client.openapi_client.models.note_update_request_data_notification_event_subscribers_inner import (
...
class NoteUpdateRequestData(BaseModel):
    ...
    notification_event_subscribers: list[NoteUpdateRequestDataNotificationEventSubscribersInner] | None = None
    subject: StrictStr | None = Field(default=None, description="Note subject.")
    __properties: ClassVar[list[str]] = ["date", "detail", "notification_event_subscribers", "subject"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "notification_event_subscribers": [NoteUpdateRequestDataNotificationEventSubscribersInner.from_dict(_item) for _item in obj["notification_event_subscribers"]] if obj.get("notification_event_subscribers") is not None else None,
