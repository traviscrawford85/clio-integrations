...
from clio_client.openapi_client.models.matter_update_request_data_statute_of_limitations_reminders_inner_notification_method import (
...
class MatterUpdateRequestDataStatuteOfLimitationsRemindersInner(BaseModel):
    ...
    """ # noqa: E501
    duration_value: StrictInt | None = Field(default=None, description="Time measured in `duration_unit` to remind user before the subject.")
    duration_unit: StrictStr | None = Field(default=None, description="Unit to measure the duration value in.")
    notification_method: MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod | None = None
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single Reminder associated with the Matter. The keyword `null` is not valid for this field.")
    destroy: StrictBool | None = Field(default=None, description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated Reminder is present, the Reminder is deleted from the Matter.", alias="_destroy")
    __properties: ClassVar[list[str]] = ["duration_value", "duration_unit", "notification_method", "id", "_destroy"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "notification_method": MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod.from_dict(obj["notification_method"]) if obj.get("notification_method") is not None else None,
            "id": obj.get("id"),
