...
from clio_client.openapi_client.models.polymorphic_custom_rate import \
...
class MatterCustomRate(BaseModel):
    ...
    rates: Optional[List[PolymorphicCustomRate]] = Field(default=None, description="PolymorphicCustomRate")
    __properties: ClassVar[List[str]] = ["type", "on_invoice", "rates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rates": [PolymorphicCustomRate.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj
