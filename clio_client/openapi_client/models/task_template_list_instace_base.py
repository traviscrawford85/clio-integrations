...
class TaskTemplateListInstaceBase(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *TaskTemplateListInstace*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *TaskTemplateListInstace*")
    created_at: datetime | None = Field(default=None, description="The time the *TaskTemplateListInstace* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *TaskTemplateListInstace* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at"]
