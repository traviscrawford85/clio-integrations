...
class InterestCharge(BaseModel):
    ...
    InterestCharge
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *InterestCharge*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *InterestCharge*")
    var_date: date | None = Field(default=None, description="The *InterestCharge* date (as a ISO-8601 date)", alias="date")
    description: StrictStr | None = Field(default=None, description="The description for the *InterestCharge*")
    total: StrictFloat | StrictInt | None = Field(default=None, description="The total amount for the *InterestCharge*")
    created_at: datetime | None = Field(default=None, description="The time the *InterestCharge* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *InterestCharge* was last updated (as a ISO-8601 timestamp)")
    ...
    __properties: ClassVar[list[str]] = ["id", "etag", "date", "description", "total", "created_at", "updated_at", "bill", "balances", "matters"]
