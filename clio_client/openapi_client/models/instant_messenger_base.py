...
class InstantMessengerBase(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *InstantMessenger*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *InstantMessenger*")
    address: StrictStr | None = Field(default=None, description="The address of the *InstantMessenger*")
    name: StrictStr | None = Field(default=None, description="The type of *InstantMessenger* it is")
    created_at: datetime | None = Field(default=None, description="The time the *InstantMessenger* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *InstantMessenger* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "address", "name", "created_at", "updated_at"]
