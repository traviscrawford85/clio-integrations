...
class MatterBillRecipient(BaseModel):
    ...
    MatterBillRecipient
    """ # noqa: E501
    created_at: datetime | None = Field(default=None, description="The time the *MatterBillRecipient* was created (as a ISO-8601 timestamp)")
    etag: StrictStr | None = Field(default=None, description="ETag for the *MatterBillRecipient*")
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *MatterBillRecipient*")
    updated_at: datetime | None = Field(default=None, description="The time the *MatterBillRecipient* was last updated (as a ISO-8601 timestamp)")
    recipient: ContactBase | None = None
    __properties: ClassVar[list[str]] = ["created_at", "etag", "id", "updated_at", "recipient"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "recipient": ContactBase.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None
        })
        return _obj
