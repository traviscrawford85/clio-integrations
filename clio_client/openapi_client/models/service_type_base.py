...
class ServiceTypeBase(BaseModel):
    ...
    ServiceTypeBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *ServiceType*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *ServiceType*")
    created_at: datetime | None = Field(default=None, description="The time the *ServiceType* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *ServiceType* was last updated (as a ISO-8601 timestamp)")
    system_id: StrictInt | None = Field(default=None, description="Server ID")
    description: StrictStr | None = Field(default=None, description="A detailed description of the *ServiceType*")
    default: StrictBool | None = Field(default=None, description="Whether *ServiceType* is default for the current user")
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at", "system_id", "description", "default"]
