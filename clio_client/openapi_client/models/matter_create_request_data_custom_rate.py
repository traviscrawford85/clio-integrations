...
from clio_client.openapi_client.models.matter_create_request_data_custom_rate_rates_inner import \
...
class MatterCreateRequestDataCustomRate(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of custom rate for the Matter.")
    rates: Optional[List[MatterCreateRequestDataCustomRateRatesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "rates": [MatterCreateRequestDataCustomRateRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj
