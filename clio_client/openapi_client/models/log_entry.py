...
class LogEntry(BaseModel):
    ...
    LogEntry
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *LogEntry*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *LogEntry*")
    type: StrictStr | None = Field(default=None, description="The type of the *LogEntry*")
    accessed_at: datetime | None = Field(default=None, description="The time the item was last accessed (as a ISO-8601 timestamp)")
    created_at: datetime | None = Field(default=None, description="The time the *LogEntry* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *LogEntry* was last updated (as a ISO-8601 timestamp)")
    item: PolymorphicObjectBase | None = None
    user: UserBase | None = None
    __properties: ClassVar[list[str]] = ["id", "etag", "type", "accessed_at", "created_at", "updated_at", "item", "user"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['MatterLogEntry', 'ContactLogEntry']):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "item": PolymorphicObjectBase.from_dict(obj["item"]) if obj.get("item") is not None else None,
