...
from clio_client.openapi_client.models.conversation_update_request_data_matter import (
...
class ConversationUpdateRequestData(BaseModel):
    ...
    """ # noqa: E501
    archived: StrictBool | None = Field(default=None, description="Whether or not the Conversation has been archived.")
    matter: ConversationUpdateRequestDataMatter | None = None
    read: StrictBool | None = Field(default=None, description="Whether or not the Conversation has been read.")
    __properties: ClassVar[list[str]] = ["archived", "matter", "read"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "matter": ConversationUpdateRequestDataMatter.from_dict(obj["matter"]) if obj.get("matter") is not None else None,
            "read": obj.get("read")
        })
        return _obj
