...
class JurisdictionsToTriggerBase(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *JurisdictionsToTrigger*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *JurisdictionsToTrigger*")
    system_id: StrictInt | None = Field(default=None, description="Server id")
    description: StrictStr | None = Field(default=None, description="A detailed description of the *JurisdictionsToTrigger*")
    do_not_recalculate: StrictBool | None = Field(default=None, description="Whether the associated dates should not be recalculated")
    is_served: StrictBool | None = Field(default=None, description="Whether the user must select a Date Offset (Service Type)")
    is_requirements_required: StrictBool | None = Field(default=None, description="Whether the trigger has requirements")
    created_at: datetime | None = Field(default=None, description="The time the *JurisdictionsToTrigger* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *JurisdictionsToTrigger* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "system_id", "description", "do_not_recalculate", "is_served", "is_requirements_required", "created_at", "updated_at"]
