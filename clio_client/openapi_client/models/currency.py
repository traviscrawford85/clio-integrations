...
class Currency(BaseModel):
    ...
    Currency
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *Currency*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *Currency*")
    code: StrictStr | None = Field(default=None, description="ISO 4217 code for the *Currency*")
    sign: StrictStr | None = Field(default=None, description="Symbol used to denote monetary values using this *Currency*")
    created_at: datetime | None = Field(default=None, description="The time the *Currency* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *Currency* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "code", "sign", "created_at", "updated_at"]
