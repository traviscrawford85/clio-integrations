...
class DocumentAutomation(BaseModel):
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['not_started', 'queued', 'in_progress', 'empty', 'failed', 'completed']):
    ...
    def export_formats_validate_enum(cls, value):
        ...
        if value not in set(['pdf', 'original']):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "document_template": DocumentTemplateBase.from_dict(obj["document_template"]) if obj.get("document_template") is not None else None,
