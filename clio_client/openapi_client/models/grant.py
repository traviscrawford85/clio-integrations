...
from clio_client.openapi_client.models.grant_funding_source_base import (
...
class Grant(BaseModel):
    ...
    grant_funding_source: GrantFundingSourceBase | None = None
    __properties: ClassVar[list[str]] = ["id", "etag", "name", "funding_code", "funding_code_and_name", "funding_source_name", "created_at", "updated_at", "balance", "start_date", "end_date", "grant_funding_source"]
