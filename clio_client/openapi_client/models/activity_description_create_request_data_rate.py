...
class ActivityDescriptionCreateRequestDataRate(BaseModel):
    ...
    """ # noqa: E501
    amount: StrictFloat | StrictInt | None = Field(default=0, description="The rate of the ActivityDescription. This is ignored for 'User' rates.")
    non_billable_amount: StrictFloat | StrictInt | None = Field(default=0, description="The non billable rate of the ActivityDescription. This is ignored for 'User' rates.")
    type: StrictStr | None = Field(default=None, description="What kind of rate it will be.")
    __properties: ClassVar[list[str]] = ["amount", "non_billable_amount", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['User', 'FlatRate', 'Custom']):
