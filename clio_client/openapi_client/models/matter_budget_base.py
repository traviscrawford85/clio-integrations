...
class MatterBudgetBase(BaseModel):
    ...
    MatterBudgetBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *MatterBudget*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *MatterBudget*")
    budget: StrictFloat | StrictInt | None = Field(default=None, description="The amount allocated for the matter.")
    include_expenses: StrictBool | None = Field(default=None, description="Whether the budget includes expenses.")
    notification_threshold: StrictInt | None = Field(default=None, description="Percentage of the budget when it starts notifying users. The number must be between 0 and 100.")
    notify_users: StrictBool | None = Field(default=None, description="Whether to notify users when the matter reaches the notification threshold.")
    created_at: datetime | None = Field(default=None, description="The time the *MatterBudget* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *MatterBudget* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "budget", "include_expenses", "notification_threshold", "notify_users", "created_at", "updated_at"]
