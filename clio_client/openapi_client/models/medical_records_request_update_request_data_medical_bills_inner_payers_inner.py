...
class MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner(BaseModel):
    ...
    """ # noqa: E501
    amount: StrictFloat | StrictInt | None = Field(default=None, description="Lien amount.")
    holder_id: StrictInt | None = Field(default=None, description="The unique identifier for a single Damage associated with the MedicalRecordsRequest. The keyword `null` is not valid for this field.")
    mark_as_lien: StrictBool | None = Field(default=None, description="Mark record as Lien.")
