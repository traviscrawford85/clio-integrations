...
class TaskTemplate(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "cascading_source": CascadingTaskTemplateBase.from_dict(obj["cascading_source"]) if obj.get("cascading_source") is not None else None,
            "assignee": UserBase.from_dict(obj["assignee"]) if obj.get("assignee") is not None else None,
            "task_template_list": TaskTemplateListBase.from_dict(obj["task_template_list"]) if obj.get("task_template_list") is not None else None,
            "task_type": TaskTypeBase.from_dict(obj["task_type"]) if obj.get("task_type") is not None else None,
            "template_creator": UserBase.from_dict(obj["template_creator"]) if obj.get("template_creator") is not None else None,
            "reminder_templates": [ReminderTemplateBase.from_dict(_item) for _item in obj["reminder_templates"]] if obj.get("reminder_templates") is not None else None
        })
        return _obj
