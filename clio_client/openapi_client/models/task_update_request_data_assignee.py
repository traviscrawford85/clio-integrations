...
class TaskUpdateRequestDataAssignee(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single User or Contact associated with the Task. The keyword `null` is not valid for this field.")
    type: StrictStr | None = Field(default=None, description="Model type of the assignee.")
