...
from clio_client.openapi_client.models.report_preset_update_request_data import (
...
class ReportPresetUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": ReportPresetUpdateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
