...
from clio_client.openapi_client.models.clio_payments_link_create_request_data import \
...
class ClioPaymentsLinkCreateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ClioPaymentsLinkCreateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
