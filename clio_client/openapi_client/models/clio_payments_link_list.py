...
from clio_client.openapi_client.models.clio_payments_link import \
    ClioPaymentsLink
...
class ClioPaymentsLinkList(BaseModel):
    ...
    """ # noqa: E501
    data: List[ClioPaymentsLink] = Field(description="ClioPaymentsLink List Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ClioPaymentsLink.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
