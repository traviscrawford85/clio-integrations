...
class NoteUpdateRequestDataNotificationEventSubscribersInner(BaseModel):
    ...
    """ # noqa: E501
    user_id: StrictStr | None = Field(default=None, description="The unique identifier for a User to be added as a notification event subscriber to the Note.")
    id: StrictInt | None = Field(default=None, description="Unique id of this Note.")
    destroy: StrictBool | None = Field(default=None, description="Whether or not the notification event subscriber should be deleted.", alias="_destroy")
