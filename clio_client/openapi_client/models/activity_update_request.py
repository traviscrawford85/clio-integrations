...
from clio_client.openapi_client.models.activity_update_request_data import \
...
class ActivityUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ActivityUpdateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
