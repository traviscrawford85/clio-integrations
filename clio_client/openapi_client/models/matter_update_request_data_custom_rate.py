...
from clio_client.openapi_client.models.matter_update_request_data_custom_rate_rates_inner import (
...
class MatterUpdateRequestDataCustomRate(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr | None = Field(default=None, description="The type of custom rate for the Matter.")
    rates: list[MatterUpdateRequestDataCustomRateRatesInner] | None = None
    __properties: ClassVar[list[str]] = ["type", "rates"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['FlatRate', 'HourlyRate', 'ContingencyFee']):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "rates": [MatterUpdateRequestDataCustomRateRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj
