...
from clio_client.openapi_client.models.outstanding_client_balance import \
...
class OutstandingClientBalanceList(BaseModel):
    ...
    """ # noqa: E501
    data: List[OutstandingClientBalance] = Field(description="OutstandingClientBalance List Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [OutstandingClientBalance.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
