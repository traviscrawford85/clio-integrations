...
class MatterUpdateRequestDataCustomFieldSetAssociationsInner(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single CustomFieldSetAssociation associated with the Matter. The keyword `null` is not valid for this field.")
    display_order: StrictInt | None = Field(default=None, description="The order to display the CustomFieldSet in a Matter. If not specified, it is added as the last CustomFieldSet of the Matter.")
    custom_field_set: ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet | None = None
    destroy: StrictBool | None = Field(default=None, description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated CustomFieldSetAssociation is present, the CustomFieldSetAssociation is deleted from the Matter.", alias="_destroy")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "custom_field_set": ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet.from_dict(obj["custom_field_set"]) if obj.get("custom_field_set") is not None else None,
