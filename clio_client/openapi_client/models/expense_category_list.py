...
class ExpenseCategoryList(BaseModel):
    ...
    ExpenseCategoryList
    """ # noqa: E501
    data: list[ExpenseCategory] = Field(description="ExpenseCategory List Response")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": [ExpenseCategory.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
