...
class Balance(BaseModel):
    ...
    Balance
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *Balance*")
    amount: StrictFloat | StrictInt | None = Field(default=None, description="The amount for this Balance.")
    type: StrictStr | None = Field(default=None, description="The type of Balance this data is for.")
    interest_amount: StrictFloat | StrictInt | None = Field(default=None, description="The interest amount for this Balance.")
    due: StrictFloat | StrictInt | None = Field(default=None, description="The amount due for this Balance, factoring in applicable discounts.")
    __properties: ClassVar[list[str]] = ["id", "amount", "type", "interest_amount", "due"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Matter', 'Client']):
