...
class LineItemUpdateRequestDataDiscount(BaseModel):
    ...
    """ # noqa: E501
    rate: StrictFloat | StrictInt | None = Field(default=None, description="Discount rate for the LineItem.")
    type: StrictBool | None = Field(default=None, description="Discount type. This should be set to one of: 'percentage' or 'money'.")
    __properties: ClassVar[list[str]] = ["rate", "type"]
