...
class TaskTemplateListBase(BaseModel):
    ...
    """ # noqa: E501
    created_at: datetime | None = Field(default=None, description="The time the *TaskTemplateList* was created (as a ISO-8601 timestamp)")
    description: StrictStr | None = Field(default=None, description="A detailed description of the *TaskTemplateList*")
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *TaskTemplateList*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *TaskTemplateList*")
    name: StrictStr | None = Field(default=None, description="The name of the *TaskTemplateList*")
    templates_count: StrictInt | None = Field(default=None, description="How many task templates exist as an association to the *TaskTemplateList*")
    updated_at: datetime | None = Field(default=None, description="The time the *TaskTemplateList* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["created_at", "description", "id", "etag", "name", "templates_count", "updated_at"]
