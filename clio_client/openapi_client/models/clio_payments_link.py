...
from clio_client.openapi_client.models.clio_payments_payment_base import (
...
class ClioPaymentsLink(BaseModel):
    ...
    clio_payments_payment: ClioPaymentsPaymentBase | None = None
    contact: ContactBase | None = None
    destination_account: BankAccountBase | None = None
    destination_contact: ContactBase | None = None
    __properties: ClassVar[list[str]] = ["active", "amount", "created_at", "currency", "description", "email_address", "etag", "expires_at", "id", "is_allocated_as_revenue", "redirect_url", "url", "bank_account", "bill", "clio_payments_payment", "contact", "destination_account", "destination_contact"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "bank_account": BankAccountBase.from_dict(obj["bank_account"]) if obj.get("bank_account") is not None else None,
            "bill": BillBase.from_dict(obj["bill"]) if obj.get("bill") is not None else None,
            "clio_payments_payment": ClioPaymentsPaymentBase.from_dict(obj["clio_payments_payment"]) if obj.get("clio_payments_payment") is not None else None,
            ...
            "destination_contact": ContactBase.from_dict(obj["destination_contact"]) if obj.get("destination_contact") is not None else None
        })
        return _obj
