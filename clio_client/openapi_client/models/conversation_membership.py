...
class ConversationMembership(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *ConversationMembership*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *ConversationMembership*")
    read: StrictBool | None = Field(default=None, description="Whether or not the ConversationMembership has been read by the member")
    archived: StrictBool | None = Field(default=None, description="Whether or not the ConversationMembership has been archived by the member")
    created_at: datetime | None = Field(default=None, description="The time the *ConversationMembership* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *ConversationMembership* was last updated (as a ISO-8601 timestamp)")
    member: dict[str, Any] | None = None
    __properties: ClassVar[list[str]] = ["id", "etag", "read", "archived", "created_at", "updated_at", "member"]
