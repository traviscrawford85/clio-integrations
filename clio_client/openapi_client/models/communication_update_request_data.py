...
class CommunicationUpdateRequestData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": obj.get("body"),
            "date": obj.get("date"),
            "external_properties": [CommunicationUpdateRequestDataExternalPropertiesInner.from_dict(_item) for _item in obj["external_properties"]] if obj.get("external_properties") is not None else None,
            "matter": CommunicationCreateRequestDataMatter.from_dict(obj["matter"]) if obj.get("matter") is not None else None,
            "notification_event_subscribers": [CommunicationUpdateRequestDataNotificationEventSubscribersInner.from_dict(_item) for _item in obj["notification_event_subscribers"]] if obj.get("notification_event_subscribers") is not None else None,
