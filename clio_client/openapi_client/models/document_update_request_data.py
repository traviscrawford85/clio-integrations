...
class DocumentUpdateRequestData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "external_properties": [DocumentCopyRequestDataExternalPropertiesInner.from_dict(_item) for _item in obj["external_properties"]] if obj.get("external_properties") is not None else None,
            "fully_uploaded": obj.get("fully_uploaded"),
            "multiparts": [DocumentUpdateRequestDataMultipartsInner.from_dict(_item) for _item in obj["multiparts"]] if obj.get("multiparts") is not None else None,
            "name": obj.get("name"),
            "parent": DocumentUpdateRequestDataParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
