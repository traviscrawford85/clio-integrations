...
class DocumentCopyRequestDataExternalPropertiesInner(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single ExternalProperty associated with the Document. The keyword `null` is not valid for this field.")
    name: StrictStr | None = Field(default=None, description="The ExternalProperty name. Note: **there is a limit of 5 external_properties per Document**")
    value: StrictStr | None = Field(default=None, description="The ExternalProperty value.")
    destroy: StrictBool | None = Field(default=None, description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated ExternalProperty is present, the ExternalProperty is deleted from the Document.", alias="_destroy")
