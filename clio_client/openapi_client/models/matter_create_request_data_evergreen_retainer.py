...
class MatterCreateRequestDataEvergreenRetainer(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["minimum_threshold", "recipients"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "recipients": [MatterCreateRequestDataEvergreenRetainerRecipientsInner.from_dict(_item) for _item in obj["recipients"]] if obj.get("recipients") is not None else None
        })
        return _obj
