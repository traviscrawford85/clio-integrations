...
class DocumentVersionBase(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["id", "document_id", "etag", "uuid", "created_at", "updated_at", "filename", "size", "version_number", "content_type", "received_at", "put_url", "fully_uploaded"]
