...
from clio_client.openapi_client.models.activity_description_create_request_data import \
...
class ActivityDescriptionCreateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ActivityDescriptionCreateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
