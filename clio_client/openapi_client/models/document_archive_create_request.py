...
from clio_client.openapi_client.models.document_archive_create_request_data import \
...
class DocumentArchiveCreateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": DocumentArchiveCreateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
