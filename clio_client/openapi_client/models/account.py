...
class Account(BaseModel):
    ...
    Account
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *Account*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *Account*")
    name: StrictStr | None = Field(default=None, description="The name of the *Account*")
    state: StrictStr | None = Field(default=None, description="Account state")
    created_at: datetime | None = Field(default=None, description="The time the *Account* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *Account* was last updated (as a ISO-8601 timestamp)")
    owner: UserBase | None = None
    __properties: ClassVar[list[str]] = ["id", "etag", "name", "state", "created_at", "updated_at", "owner"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "owner": UserBase.from_dict(obj["owner"]) if obj.get("owner") is not None else None
        })
        return _obj
