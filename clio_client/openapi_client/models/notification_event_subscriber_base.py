...
class NotificationEventSubscriberBase(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *NotificationEventSubscriber*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *NotificationEventSubscriber*")
    user_id: StrictInt | None = Field(default=None, description="The unique identifier for a User added as a notification event subscriber to the NotificationEventSubscriber")
    name: StrictStr | None = Field(default=None, description="The User name added as a notification event subscriber to the NotificationEventSubscriber")
    created_at: datetime | None = Field(default=None, description="The time the *NotificationEventSubscriber* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *NotificationEventSubscriber* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "user_id", "name", "created_at", "updated_at"]
