...
class MatterUpdateRequestDataCustomFieldValuesInner(BaseModel):
    ...
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single CustomFieldValue associated with the Matter. The keyword `null` is not valid for this field.")
    destroy: StrictBool | None = Field(default=None, description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated CustomFieldValue is present, the CustomFieldValue is deleted from the Matter.", alias="_destroy")
