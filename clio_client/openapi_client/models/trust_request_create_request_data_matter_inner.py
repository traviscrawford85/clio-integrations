...
class TrustRequestCreateRequestDataMatterInner(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="The matter id associated to the TrustRequest")
    trust_amount: StrictInt | None = Field(default=None, description="The matter level TrustRequest's amount")
    note: StrictStr | None = Field(default=None, description="The client level TrustRequest note")
    __properties: ClassVar[list[str]] = ["id", "trust_amount", "note"]
