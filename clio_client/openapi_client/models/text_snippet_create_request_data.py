...
class TextSnippetCreateRequestData(BaseModel):
    ...
    """ # noqa: E501
    phrase: StrictStr = Field(description="The phrase expanded to from a TextSnippet.")
    snippet: StrictStr = Field(description="The abbreviation that expands to a phrase.")
