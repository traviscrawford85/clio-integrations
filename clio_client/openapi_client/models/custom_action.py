...
class CustomAction(BaseModel):
    ...
    CustomAction
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *CustomAction*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *CustomAction*")
    created_at: datetime | None = Field(default=None, description="The time the *CustomAction* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *CustomAction* was last updated (as a ISO-8601 timestamp)")
    label: StrictStr | None = Field(default=None, description="Text label to be displayed on the custom link.")
    target_url: StrictStr | None = Field(default=None, description="Target URL which will be opened in a new tab when the user clicks the custom link.")
    ui_reference: StrictStr | None = Field(default=None, description="UI reference location within Clio where the link will be displayed.")
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at", "label", "target_url", "ui_reference"]
    ...
    def ui_reference_validate_enum(cls, value):
        ...
        if value not in set(['activities/show', 'documents/show', 'contacts/show', 'matters/show', 'folders/show']):
