...
class DocumentVersionList(BaseModel):
    ...
    DocumentVersionList
    """ # noqa: E501
    data: List[DocumentVersion] = Field(description="DocumentVersion List Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DocumentVersion.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
