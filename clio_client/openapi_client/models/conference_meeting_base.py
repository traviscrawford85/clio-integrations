...
class ConferenceMeetingBase(BaseModel):
    ...
    """ # noqa: E501
    conference_id: StrictInt | None = Field(default=None, description="Third-party provider unique meeting ID")
    conference_password: StrictStr | None = Field(default=None, description="Third-party provider meeting password")
    created_at: datetime | None = Field(default=None, description="The time the *ConferenceMeeting* was created (as a ISO-8601 timestamp)")
    etag: StrictStr | None = Field(default=None, description="ETag for the *ConferenceMeeting*")
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *ConferenceMeeting*")
    join_url: StrictStr | None = Field(default=None, description="URL for participants to join the video conference")
    type: StrictStr | None = Field(default=None, description="The type of video conference")
    source_id: StrictInt | None = Field(default=None, description="The external ID of the video conference meeting")
    updated_at: datetime | None = Field(default=None, description="The time the *ConferenceMeeting* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["conference_id", "conference_password", "created_at", "etag", "id", "join_url", "type", "source_id", "updated_at"]
