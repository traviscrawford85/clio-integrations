...
from clio_client.openapi_client.models.medical_records_request_update_request_data_medical_bills_inner import (
    MedicalRecordsRequestUpdateRequestDataMedicalBillsInner,
)
from clio_client.openapi_client.models.medical_records_request_update_request_data_medical_records_inner import (
...
class MedicalRecordsRequestUpdateRequestData(BaseModel):
    ...
    bills_status: StrictStr | None = Field(default=None, description="Current status for the Medical Bills.")
    description: StrictStr | None = Field(default=None, description="Detailed description of the Medical Records Detail.")
    in_treatment: StrictBool | None = Field(default=None, description="True or false value to record if the treatment has been completed.")
    medical_bills: list[MedicalRecordsRequestUpdateRequestDataMedicalBillsInner] | None = None
    medical_provider_id: StrictInt | None = Field(default=None, description="The unique identifier for a single Medical Provider associated with this Medical Records Detail.")
    medical_records: list[MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner] | None = None
    ...
    records_status: StrictStr | None = Field(default=None, description="Current status for the Medical Records.")
    ...
    __properties: ClassVar[list[str]] = ["bills_follow_up_date", "bills_request_date", "bills_status", "description", "in_treatment", "medical_bills", "medical_provider_id", "medical_records", "records_follow_up_date", "records_request_date", "records_status", "treatment_end_date", "treatment_start_date"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "medical_bills": [MedicalRecordsRequestUpdateRequestDataMedicalBillsInner.from_dict(_item) for _item in obj["medical_bills"]] if obj.get("medical_bills") is not None else None,
            "medical_provider_id": obj.get("medical_provider_id"),
            "medical_records": [MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner.from_dict(_item) for _item in obj["medical_records"]] if obj.get("medical_records") is not None else None,
