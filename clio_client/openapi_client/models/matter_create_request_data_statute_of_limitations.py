...
from clio_client.openapi_client.models.matter_create_request_data_statute_of_limitations_reminders_inner import (
...
class MatterCreateRequestDataStatuteOfLimitations(BaseModel):
    ...
    reminders: list[MatterCreateRequestDataStatuteOfLimitationsRemindersInner] | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "reminders": [MatterCreateRequestDataStatuteOfLimitationsRemindersInner.from_dict(_item) for _item in obj["reminders"]] if obj.get("reminders") is not None else None
        })
        return _obj
