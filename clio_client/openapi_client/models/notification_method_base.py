...
class NotificationMethodBase(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *NotificationMethod*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *NotificationMethod*")
    type: StrictStr | None = Field(default=None, description="Human readable description of the type of notification")
    email_address: StrictStr | None = Field(default=None, description="Email address to send the notification to (only for email type)")
    is_default_email_address: StrictBool | None = Field(default=None, description="A boolean that is returned only on notification method objects that are relevant e.g. Email notification or Alternative Email")
    created_at: datetime | None = Field(default=None, description="The time the *NotificationMethod* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *NotificationMethod* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "type", "email_address", "is_default_email_address", "created_at", "updated_at"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Email', 'Popup', 'SMS']):
