...
class CalendarEntryCreateRequestDataAttendeesInner(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="The unique identifier for a single Attendee associated with the CalendarEntry. The keyword `null` is not valid for this field. Not required for creating new Attendee, but required for updating or deleting existing ones.")
    type: StrictStr | None = Field(default=None, description="The type of attendee (Calendar, Contact)")
    destroy: StrictBool | None = Field(default=None, description="Flag to delete a specific attendee.", alias="_destroy")
    __properties: ClassVar[list[str]] = ["id", "type", "_destroy"]
