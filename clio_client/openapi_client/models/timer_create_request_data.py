...
from clio_client.openapi_client.models.timer_create_request_data_activity import (
...
class TimerCreateRequestData(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "activity": TimerCreateRequestDataActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None
        })
        return _obj
