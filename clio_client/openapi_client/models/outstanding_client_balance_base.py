...
class OutstandingClientBalanceBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["associated_matter_ids", "etag", "id", "last_payment_date", "last_shared_date", "newest_issued_bill_due_date", "pending_payments_total", "reminders_enabled", "total_outstanding_balance", "created_at", "updated_at"]
