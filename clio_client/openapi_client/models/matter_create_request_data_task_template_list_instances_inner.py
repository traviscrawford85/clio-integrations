...
from clio_client.openapi_client.models.matter_create_request_data_task_template_list_instances_inner_task_template_list import (
...
class MatterCreateRequestDataTaskTemplateListInstancesInner(BaseModel):
    ...
    assignee_id: StrictInt | None = Field(default=None, description="The id of the user to assign the task template list to.")
    notify_assignees: StrictBool | None = Field(default=None, description="Whether or not task list assignees should be notified when the task list is assigned to a matter.")
    due_at: date | None = Field(default=None, description="Due date of the tasks. (Expects an ISO-8601 date).")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "task_template_list": MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList.from_dict(obj["task_template_list"]) if obj.get("task_template_list") is not None else None,
