...
class CalendarEntryEventTypeCreateRequestData(BaseModel):
    ...
    """ # noqa: E501
    color: StrictStr = Field(description="The color assigned to the CalendarEntryEventType")
    name: StrictStr = Field(description="The name of the CalendarEntryEventType")
