...
class Multipart(BaseModel):
    ...
    Multipart
    """ # noqa: E501
    part_number: StrictInt | None = Field(default=None, description="Unique identifier of a part which defines its position within the document being uploaded.")
    put_url: StrictStr | None = Field(default=None, description="A signed URL for uploading the file part. It expires in 10 minutes.")
    put_headers: list[MultipartHeaderBase] | None = Field(default=None, description="MultipartHeader")
    __properties: ClassVar[list[str]] = ["part_number", "put_url", "put_headers"]
