...
from clio_client.openapi_client.models.grant_funding_source import \
    GrantFundingSource
...
class GrantFundingSourceList(BaseModel):
    ...
    """ # noqa: E501
    data: List[GrantFundingSource] = Field(description="GrantFundingSource List Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GrantFundingSource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
