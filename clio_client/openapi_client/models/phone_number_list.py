...
class PhoneNumberList(BaseModel):
    ...
    PhoneNumberList
    """ # noqa: E501
    data: list[PhoneNumber] = Field(description="PhoneNumber List Response")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": [PhoneNumber.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
