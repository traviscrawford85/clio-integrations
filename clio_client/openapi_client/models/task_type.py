...
class TaskType(BaseModel):
    ...
    TaskType
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *TaskType*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *TaskType*")
    name: StrictStr | None = Field(default=None, description="The name of the *TaskType*")
    deleted_at: datetime | None = Field(default=None, description="The time the *TaskType* was deleted (as a ISO-8601 timestamp)")
    created_at: datetime | None = Field(default=None, description="The time the *TaskType* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *TaskType* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "name", "deleted_at", "created_at", "updated_at"]
