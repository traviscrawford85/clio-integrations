...
class RelatedContactsList(BaseModel):
    ...
    RelatedContactsList
    """ # noqa: E501
    data: list[RelatedContacts] = Field(description="RelatedContacts List Response")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": [RelatedContacts.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
