...
from clio_client.openapi_client.models.communication_update_request_data import \
...
class CommunicationUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CommunicationUpdateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
