...
class CalendarEntryCreateRequestDataConferenceMeeting(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr | None = Field(default=None, description="The type of conference meeting. If no conference meeting is present or the user is in an ineligible pricing tier for this feature, it will be null.")
