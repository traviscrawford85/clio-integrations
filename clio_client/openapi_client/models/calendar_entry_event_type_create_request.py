...
from clio_client.openapi_client.models.calendar_entry_event_type_create_request_data import \
...
class CalendarEntryEventTypeCreateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CalendarEntryEventTypeCreateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
