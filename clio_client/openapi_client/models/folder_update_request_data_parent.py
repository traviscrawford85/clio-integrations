...
class FolderUpdateRequestDataParent(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Folder', 'Contact', 'Matter']):
