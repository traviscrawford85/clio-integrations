...
from clio_client.openapi_client.models.polymorphic_custom_rate_activity_description_base import (
    PolymorphicCustomRateActivityDescriptionBase,
)
from clio_client.openapi_client.models.polymorphic_custom_rate_group_base import (
    PolymorphicCustomRateGroupBase,
)
from clio_client.openapi_client.models.polymorphic_custom_rate_user_base import (
...
class PolymorphicCustomRate(BaseModel):
    ...
    user: PolymorphicCustomRateUserBase | None = None
    group: PolymorphicCustomRateGroupBase | None = None
    activity_description: PolymorphicCustomRateActivityDescriptionBase | None = None
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at", "rate", "award", "note", "date", "user", "group", "activity_description"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "note": obj.get("note"),
            "date": obj.get("date"),
            "user": PolymorphicCustomRateUserBase.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "group": PolymorphicCustomRateGroupBase.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "activity_description": PolymorphicCustomRateActivityDescriptionBase.from_dict(obj["activity_description"]) if obj.get("activity_description") is not None else None
        })
        return _obj
