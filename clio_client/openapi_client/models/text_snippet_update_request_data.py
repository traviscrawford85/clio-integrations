...
class TextSnippetUpdateRequestData(BaseModel):
    ...
    """ # noqa: E501
    phrase: StrictStr | None = Field(default=None, description="The phrase expanded to from a TextSnippet.")
    snippet: StrictStr | None = Field(default=None, description="The abbreviation that expands to a phrase.")
    whole_word: StrictBool | None = Field(default=None, description="Whether or not the TextSnippet requires a space after to trigger the expansion.")
    __properties: ClassVar[list[str]] = ["phrase", "snippet", "whole_word"]
