...
class Webhook(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["id", "etag", "url", "fields", "shared_secret", "model", "status", "events", "expires_at", "created_at", "updated_at", "user"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['pending', 'enabled', 'suspended']):
