...
class TrustRequestBase(BaseModel):
    ...
    TrustRequestBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *TrustRequest*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *TrustRequest*")
    created_at: datetime | None = Field(default=None, description="The time the *TrustRequest* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *TrustRequest* was last updated (as a ISO-8601 timestamp)")
