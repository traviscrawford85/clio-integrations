...
from clio_client.openapi_client.models.calendar_visibility import \
    CalendarVisibility
...
class CalendarVisibilityList(BaseModel):
    ...
    """ # noqa: E501
    data: List[CalendarVisibility] = Field(description="CalendarVisibility List Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CalendarVisibility.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
