...
class DocumentTemplateUpdateRequestData(BaseModel):
    ...
    file: StrictStr | None = Field(default=None, description="A file that contains the DocumentTemplate. The file can be uploaded through a form as application/x-www-form-urlencoded or multipart/form-data request. Alternatively, the file can be converted to a BASE64-encoded string and serialized to JSON. ")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "document_category": DocumentTemplateCreateRequestDataDocumentCategory.from_dict(obj["document_category"]) if obj.get("document_category") is not None else None,
            "file": obj.get("file"),
