...
from clio_client.openapi_client.models.line_item_totals_base import \
    LineItemTotalsBase
...
class LineItem(BaseModel):
    ...
    var_date: Optional[date] = Field(default=None, description="The *LineItem* date (as a ISO-8601 date)", alias="date")
