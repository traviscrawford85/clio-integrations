...
class LineItem(BaseModel):
    ...
    LineItem
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *LineItem*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *LineItem*")
    type: StrictStr | None = Field(default=None, description="The type of the *LineItem*")
    description: StrictStr | None = Field(default=None, description="The description for the *LineItem*")
    var_date: date | None = Field(default=None, description="The *LineItem* date (as a ISO-8601 date)", alias="date")
    price: StrictFloat | StrictInt | None = Field(default=None, description="The price of the *LineItem*")
    taxable: StrictBool | None = Field(default=None, description="Whether the *LineItem* is taxable")
    kind: StrictStr | None = Field(default=None, description="The kind of *LineItem*")
    ...
    total: StrictFloat | StrictInt | None = Field(default=None, description="The total amount for the *LineItem*")
    tax: StrictFloat | StrictInt | None = Field(default=None, description="The tax amount for the *LineItem*")
    secondary_tax: StrictFloat | StrictInt | None = Field(default=None, description="The secondary tax amount for the *LineItem*")
    sub_total: StrictFloat | StrictInt | None = Field(default=None, description="The subtotal amount for the *LineItem*")
    quantity: StrictFloat | StrictInt | None = Field(default=None, description="The amount of hours for the *LineItem*")
    group_ordering: StrictInt | None = Field(default=None, description="The value to specify the ordering of the *LineItem* on a bill")
    created_at: datetime | None = Field(default=None, description="The time the *LineItem* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *LineItem* was last updated (as a ISO-8601 timestamp)")
    bill: BillBase | None = None
    activity: ActivityBase | None = None
    matter: MatterBase | None = None
    user: UserBase | None = None
    discount: DiscountBase | None = None
    included_line_item_totals: LineItemTotalsBase | None = None
    __properties: ClassVar[list[str]] = ["id", "etag", "type", "description", "date", "price", "taxable", "kind", "note", "secondary_taxable", "total", "tax", "secondary_tax", "sub_total", "quantity", "group_ordering", "created_at", "updated_at", "bill", "activity", "matter", "user", "discount", "included_line_item_totals"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['ActivityLineItem', 'LineItem', 'NoChargeLineItem', 'SummaryLineItem']):
    ...
    def kind_validate_enum(cls, value):
        ...
        if value not in set(['Service', 'Expense']):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "activity": ActivityBase.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            ...
            "included_line_item_totals": LineItemTotalsBase.from_dict(obj["included_line_item_totals"]) if obj.get("included_line_item_totals") is not None else None
        })
        return _obj
