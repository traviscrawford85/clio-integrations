...
class PicklistOption(BaseModel):
    ...
    PicklistOption
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *PicklistOption*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *PicklistOption*")
    created_at: datetime | None = Field(default=None, description="The time the *PicklistOption* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *PicklistOption* was last updated (as a ISO-8601 timestamp)")
    option: StrictStr | None = Field(default=None, description="The value of the *PicklistOption*")
    deleted_at: datetime | None = Field(default=None, description="The time the *PicklistOption* was deleted (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at", "option", "deleted_at"]
