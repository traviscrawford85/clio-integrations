...
class TrustRequestCreateRequestData(BaseModel):
    ...
    matter: Optional[List[TrustRequestCreateRequestDataMatterInner]] = None
    note: Optional[StrictStr] = Field(default=None, description="The client level TrustRequest note")
    trust_amount: Union[StrictFloat, StrictInt] = Field(description="The TrustRequest's amount")
