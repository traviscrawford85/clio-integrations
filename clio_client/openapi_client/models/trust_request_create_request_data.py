...
from clio_client.openapi_client.models.trust_request_create_request_data_matter_inner import (
...
class TrustRequestCreateRequestData(BaseModel):
    ...
    """ # noqa: E501
    approved: StrictBool = Field(description="Whether or not the TrustRequest should be automatically approved.")
    client_id: StrictInt = Field(description="The client_id associated to the TrustRequest")
    due_date: date = Field(description="The date the TrustRequest is due (Expects an ISO-8601 date).")
    issue_date: date = Field(description="The date the TrustRequest is issued (Expects an ISO-8601 date).")
    matter: list[TrustRequestCreateRequestDataMatterInner] | None = None
    note: StrictStr | None = Field(default=None, description="The client level TrustRequest note")
    trust_amount: StrictFloat | StrictInt = Field(description="The TrustRequest's amount")
    trust_type: StrictStr = Field(description="The type of TrustRequest")
    __properties: ClassVar[list[str]] = ["approved", "client_id", "due_date", "issue_date", "matter", "note", "trust_amount", "trust_type"]
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.matter:
            for _item_matter in self.matter:
                if _item_matter:
                    _items.append(_item_matter.to_dict())
            _dict['matter'] = _items
        return _dict
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "matter": [TrustRequestCreateRequestDataMatterInner.from_dict(_item) for _item in obj["matter"]] if obj.get("matter") is not None else None,
            "note": obj.get("note"),
