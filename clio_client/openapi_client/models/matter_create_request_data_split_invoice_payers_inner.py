...
class MatterCreateRequestDataSplitInvoicePayersInner(BaseModel):
    ...
    """ # noqa: E501
    contact_id: StrictInt = Field(description="Contact id for the matter payer.")
    ...
    split_portion: StrictFloat | StrictInt = Field(description="The split portion for the payer.")
    __properties: ClassVar[list[str]] = ["contact_id", "send_to_bill_recipients", "split_portion"]
