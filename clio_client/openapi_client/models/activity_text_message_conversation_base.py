...
class ActivityTextMessageConversationBase(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *TextMessageConversation*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *TextMessageConversation*")
    __properties: ClassVar[list[str]] = ["id", "etag"]
