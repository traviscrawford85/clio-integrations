...
class EmailAddressBase(BaseModel):
    ...
    EmailAddressBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *EmailAddress*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *EmailAddress*")
    address: StrictStr | None = Field(default=None, description="The address of the *EmailAddress*")
    name: StrictStr | None = Field(default=None, description="A descriptive name for the *EmailAddress. Common values include `Home`, `Work`, and `Other`, as these are the only selectable options within Clio Manage, but other values may be returned for this field.")
    primary: StrictBool | None = Field(default=None, description="Whether it is the default for this contact")
    created_at: datetime | None = Field(default=None, description="The time the *EmailAddress* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *EmailAddress* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "address", "name", "primary", "created_at", "updated_at"]
