...
from clio_client.openapi_client.models.text_snippet_create_request_data import (
...
class TextSnippetCreateRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": TextSnippetCreateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
