...
class MatterCreateRequestDataEvergreenRetainerRecipientsInner(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="the `id` of a User who will receive the trust balance notification.")
    destroy: StrictBool | None = Field(default=None, description="Used to remove an existing User as a recipient of the trust balance notification.", alias="_destroy")
    __properties: ClassVar[list[str]] = ["id", "_destroy"]
