...
class MatterCreateRequestDataEvergreenRetainerRecipientsInner(BaseModel):
    ...
    destroy: Optional[StrictBool] = Field(default=None, description="Used to remove an existing User as a recipient of the trust balance notification.", alias="_destroy")
