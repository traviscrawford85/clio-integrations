...
from clio_client.openapi_client.models.medical_records_request import \
...
class MedicalRecordsRequestList(BaseModel):
    ...
    """ # noqa: E501
    data: List[MedicalRecordsRequest] = Field(description="MedicalRecordsRequest List Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MedicalRecordsRequest.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
