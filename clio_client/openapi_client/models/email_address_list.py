...
class EmailAddressList(BaseModel):
    ...
    EmailAddressList
    """ # noqa: E501
    data: list[EmailAddress] = Field(description="EmailAddress List Response")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": [EmailAddress.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
