...
class ContingencyFeeBase(BaseModel):
    ...
    ContingencyFeeBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *ContingencyFee*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *ContingencyFee*")
    created_at: datetime | None = Field(default=None, description="The time the *ContingencyFee* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *ContingencyFee* was last updated (as a ISO-8601 timestamp)")
    show_contingency_award: StrictBool | None = Field(default=None, description="Whether the *ContingencyFee* is posted or on a bill")
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at", "show_contingency_award"]
