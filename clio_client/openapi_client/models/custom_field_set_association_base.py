...
class CustomFieldSetAssociationBase(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *CustomFieldSetAssociation*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *CustomFieldSetAssociation*")
    display_order: StrictInt | None = Field(default=None, description="The display position of the *CustomFieldSetAssociation*")
    created_at: datetime | None = Field(default=None, description="The time the *CustomFieldSetAssociation* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *CustomFieldSetAssociation* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "display_order", "created_at", "updated_at"]
