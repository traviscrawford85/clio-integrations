...
from clio_client.openapi_client.models.comment_update_request_data_item import (
...
class CommentUpdateRequestData(BaseModel):
    ...
    """ # noqa: E501
    item: CommentUpdateRequestDataItem | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "item": CommentUpdateRequestDataItem.from_dict(obj["item"]) if obj.get("item") is not None else None,
