...
class AttendeeBase(BaseModel):
    ...
    AttendeeBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *Attendee*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *Attendee*")
    type: StrictStr | None = Field(default=None, description="The class name of the *Attendee*")
    name: StrictStr | None = Field(default=None, description="The name of the *Attendee*")
    enabled: StrictBool | None = Field(default=None, description="If the Attendee is a user, represents whether the user is enabled or disabled. Returns null if attendee is a Contact.")
    email: StrictStr | None = Field(default=None, description="If the Attendee is a User, this is the User's email. If the Attendee is a contact, this is the Contact's primary email address.")
    created_at: datetime | None = Field(default=None, description="The time the *Attendee* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *Attendee* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "type", "name", "enabled", "email", "created_at", "updated_at"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Contact', 'Calendar']):
