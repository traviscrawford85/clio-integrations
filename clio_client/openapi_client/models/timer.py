...
class Timer(BaseModel):
    ...
    Timer
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *Timer*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *Timer*")
    start_time: datetime | None = Field(default=None, description="The time the *Timer* was started (as ISO-8601 timestamp)")
    elapsed_time: StrictFloat | StrictInt | None = Field(default=None, description="How much time has elapsed, in hours, since the timer was started")
    created_at: datetime | None = Field(default=None, description="The time the *Timer* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *Timer* was last updated (as a ISO-8601 timestamp)")
    activity: ActivityBase | None = None
    __properties: ClassVar[list[str]] = ["id", "etag", "start_time", "elapsed_time", "created_at", "updated_at", "activity"]
