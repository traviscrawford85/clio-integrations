...
class PolymorphicObjectBase(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *PolymorphicObject*")
    type: StrictStr | None = Field(default=None, description="The type of the *PolymorphicObject*")
    identifier: StrictStr | None = Field(default=None, description="A string to identify the *PolymorphicObject*")
    secondary_identifier: StrictStr | None = Field(default=None, description="A secondary string to identify the *PolymorphicObject*")
    tertiary_identifier: StrictStr | None = Field(default=None, description="A tertiary string to identify the *PolymorphicObject*")
    __properties: ClassVar[list[str]] = ["id", "type", "identifier", "secondary_identifier", "tertiary_identifier"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Task', 'CalendarEntry', 'MatterNote', 'ContactNote', 'Matter', 'Contact', 'User', 'CreditMemo', 'Payment']):
