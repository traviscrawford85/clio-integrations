...
from clio_client.openapi_client.models.task_template_update_request_data import (
...
class TaskTemplateUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": TaskTemplateUpdateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
