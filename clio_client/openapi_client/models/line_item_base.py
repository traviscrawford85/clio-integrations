...
class LineItemBase(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["id", "etag", "type", "description", "date", "price", "taxable", "kind", "note", "secondary_taxable", "total", "tax", "secondary_tax", "sub_total", "quantity", "group_ordering", "created_at", "updated_at"]
