...
from clio_client.openapi_client.models.clio_payments_payment import \
    ClioPaymentsPayment
...
class ClioPaymentsPaymentList(BaseModel):
    ...
    """ # noqa: E501
    data: List[ClioPaymentsPayment] = Field(description="ClioPaymentsPayment List Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ClioPaymentsPayment.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
