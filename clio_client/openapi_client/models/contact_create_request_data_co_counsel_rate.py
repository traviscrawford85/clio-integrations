...
class ContactCreateRequestDataCoCounselRate(BaseModel):
    ...
    """ # noqa: E501
    rate: StrictFloat | StrictInt | None = Field(default=None, description="Billing rate if the Contact is a co-counsel.  Note: this value can only be provided during PATCH requests. It cannot be provided at the time a Contact is created (i.e. POST requests). ")
