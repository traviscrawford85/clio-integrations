...
class Relationship(BaseModel):
    ...
    Relationship
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *Relationship*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *Relationship*")
    description: StrictStr | None = Field(default=None, description="A detailed description of the *Relationship*")
    created_at: datetime | None = Field(default=None, description="The time the *Relationship* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *Relationship* was last updated (as a ISO-8601 timestamp)")
    matter: MatterBase | None = None
    contact: ContactBase | None = None
    __properties: ClassVar[list[str]] = ["id", "etag", "description", "created_at", "updated_at", "matter", "contact"]
