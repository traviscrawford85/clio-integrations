...
from clio_client.openapi_client.models.jurisdictions_to_trigger import (
...
class JurisdictionsToTriggerList(BaseModel):
    ...
    """ # noqa: E501
    data: list[JurisdictionsToTrigger] = Field(description="JurisdictionsToTrigger List Response")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": [JurisdictionsToTrigger.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
