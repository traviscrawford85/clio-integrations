...
class ParticipantBase(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["id", "etag", "created_at", "updated_at", "type", "identifier", "secondary_identifier", "enabled", "name", "initials", "job_title_name"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Person', 'Company', 'User']):
