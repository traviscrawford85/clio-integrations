...
class MatterBalanceBase(BaseModel):
    ...
    MatterBalanceBase
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *MatterBalance*")
    amount: StrictFloat | StrictInt | None = Field(default=None, description="The amount of balance of a matter.")
