...
class ExpenseCategoryCreateRequestDataGroupsInner(BaseModel):
    ...
    deleted: Optional[StrictBool] = Field(default=None, description="A flag to determine if this Group should lose access to this ExpenseCategory.", alias="_deleted")
