...
from clio_client.openapi_client.models.conversation_message import \
    ConversationMessage
...
class ConversationMessageList(BaseModel):
    ...
    """ # noqa: E501
    data: List[ConversationMessage] = Field(description="ConversationMessage List Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ConversationMessage.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
