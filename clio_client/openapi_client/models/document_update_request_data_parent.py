...
class DocumentUpdateRequestDataParent(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Document', 'Folder', 'Contact', 'Matter']):
