...
class PhoneNumber(BaseModel):
    ...
    PhoneNumber
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *PhoneNumber*")
    etag: StrictStr | None = Field(default=None, description="ETag for the *PhoneNumber*")
    number: StrictStr | None = Field(default=None, description="Contact's Phone Number")
    name: StrictStr | None = Field(default=None, description="The type of *PhoneNumber* it is")
    primary: StrictBool | None = Field(default=None, description="Whether it is default for this contact")
    created_at: datetime | None = Field(default=None, description="The time the *PhoneNumber* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *PhoneNumber* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[list[str]] = ["id", "etag", "number", "name", "primary", "created_at", "updated_at"]
