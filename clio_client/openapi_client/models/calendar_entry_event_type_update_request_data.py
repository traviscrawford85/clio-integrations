...
class CalendarEntryEventTypeUpdateRequestData(BaseModel):
    ...
    """ # noqa: E501
    color: StrictStr | None = Field(default=None, description="The color assigned to the CalendarEntryEventType")
    name: StrictStr | None = Field(default=None, description="The name of the CalendarEntryEventType")
