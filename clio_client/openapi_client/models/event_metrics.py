...
class EventMetrics(BaseModel):
    ...
    EventMetrics
    """ # noqa: E501
    unread_mobile_events: StrictInt | None = Field(default=None, description="The number of unread mobile event notifications for the current user")
    unread_web_events: StrictInt | None = Field(default=None, description="The number of unread web event notifications for the current user")
    unread_secure_messages: StrictInt | None = Field(default=None, description="The number of unread secure messages for the current user")
    unread_client_portal_messages: StrictInt | None = Field(default=None, description="The number of unread client portal messages for the current user")
    unread_text_messages: StrictInt | None = Field(default=None, description="The number of unread text messages for the current user")
    __properties: ClassVar[list[str]] = ["unread_mobile_events", "unread_web_events", "unread_secure_messages", "unread_client_portal_messages", "unread_text_messages"]
