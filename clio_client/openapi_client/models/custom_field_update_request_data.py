...
class CustomFieldUpdateRequestData(BaseModel):
    ...
    name: StrictStr | None = Field(default=None, description="CustomField name.")
    ...
    __properties: ClassVar[list[str]] = ["display_order", "displayed", "name", "picklist_options", "required"]
