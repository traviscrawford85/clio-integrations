...
from clio_client.openapi_client.models.my_event_update_request_data import \
...
class MyEventUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": MyEventUpdateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
