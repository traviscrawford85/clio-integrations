...
class EvergreenRetainerBase(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt | None = Field(default=None, description="Unique identifier for the *EvergreenRetainer*")
    created_at: datetime | None = Field(default=None, description="The time the *EvergreenRetainer* was created (as a ISO-8601 timestamp)")
    updated_at: datetime | None = Field(default=None, description="The time the *EvergreenRetainer* was last updated (as a ISO-8601 timestamp)")
    etag: StrictStr | None = Field(default=None, description="ETag for the *EvergreenRetainer*")
    minimum_threshold: StrictFloat | StrictInt | None = Field(default=None, description="The trust balance threshold for the associated Matter. When the balance falls below the threshold, the retainer's associated recipients (firm users) will receive a notification.")
    __properties: ClassVar[list[str]] = ["id", "created_at", "updated_at", "etag", "minimum_threshold"]
