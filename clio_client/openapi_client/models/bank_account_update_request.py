...
from clio_client.openapi_client.models.bank_account_update_request_data import (
...
class BankAccountUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": BankAccountUpdateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
