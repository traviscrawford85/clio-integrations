...
class ReportPresetUpdateRequestData(BaseModel):
    ...
    """ # noqa: E501
    format: StrictStr | None = Field(default=None, description="What format the report will be generated in.")
    kind: StrictStr | None = Field(default=None, description="What kind of report will be generated.")
    name: StrictStr | None = Field(default=None, description="Name of the ReportPreset.")
    options: StrictStr | None = Field(default=None, description="What the report generation parameters are. See [Creating a Report Preset](#section/Creating-a-Report-Preset) for a sample request.")
