...
class ActivityRateCreateRequestData(BaseModel):
    ...
    """ # noqa: E501
    co_counsel_contact_id: StrictInt | None = Field(default=None, description="The unique identifier for a single Contact associated with the ActivityRate. The keyword `null` is not valid for this field.")
    contact_id: StrictInt | None = Field(default=None, description="The unique identifier for a single Contact associated with the ActivityRate. The keyword `null` is not valid for this field.")
    ...
    __properties: ClassVar[list[str]] = ["co_counsel_contact_id", "contact_id", "flat_rate", "rate"]
