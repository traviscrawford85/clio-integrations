...
from clio_client.openapi_client.models.lauk_criminal_controlled_rate import (
...
class LaukCriminalControlledRateList(BaseModel):
    ...
    """ # noqa: E501
    data: list[LaukCriminalControlledRate] = Field(description="LaukCriminalControlledRate List Response")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": [LaukCriminalControlledRate.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
