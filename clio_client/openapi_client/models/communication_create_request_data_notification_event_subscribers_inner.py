...
class CommunicationCreateRequestDataNotificationEventSubscribersInner(BaseModel):
    ...
    """ # noqa: E501
    user_id: StrictStr = Field(description="The unique identifier for a User to be added as a notification event subscriber to the Phone Log Communication. Note: Only applicable to Phone Log Communications, invalid for other communication types.")
