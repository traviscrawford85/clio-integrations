...
from clio_client.openapi_client.models.task_type_create_request import (
...
from clio_client.openapi_client.models.task_type_update_request import (
    ApiResponse,
...
class TaskTypesApi:
    ...
    def task_type_create(
        ...
        task_type_create_request: Annotated[Optional[TaskTypeCreateRequest], Field(description="Request Body for Task Types")] = None,
        ...
        _param = self._task_type_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            task_type_create_request=task_type_create_request,
    ...
    @validate_call
    def task_type_create_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        task_type_create_request: Annotated[Optional[TaskTypeCreateRequest], Field(description="Request Body for Task Types")] = None,
    ...
    @validate_call
    def task_type_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        task_type_create_request: Annotated[Optional[TaskTypeCreateRequest], Field(description="Request Body for Task Types")] = None,
    ...
    def _task_type_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if task_type_create_request is not None:
            _body_params = task_type_create_request
    ...
    def task_type_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter TaskType records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        enabled: Annotated[Optional[StrictBool], Field(description="Filter TaskType records to those that are enabled or disabled.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter TaskType records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of TaskType records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Filter TaskType records to those with the given name.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the TaskType records by the given field. Default: `id(asc)`.")] = None,
        ...
        updated_since: Annotated[Optional[datetime], Field(description="Filter TaskType records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._task_type_index_serialize(
            x_api_version=x_api_version,
    ...
    @validate_call
    def task_type_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter TaskType records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        enabled: Annotated[Optional[StrictBool], Field(description="Filter TaskType records to those that are enabled or disabled.")] = None,
    ...
    def _task_type_index_serialize(
        self,
        x_api_version,
        created_since,
        enabled,
    ...
    def task_type_show(
        ...
        _param = self._task_type_show_serialize(
            id=id,
    ...
    @validate_call
    def task_type_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TaskType.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _task_type_show_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/task_types/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def task_type_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        task_type_update_request: Annotated[Optional[TaskTypeUpdateRequest], Field(description="Request Body for Task Types")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._task_type_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            task_type_update_request=task_type_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def task_type_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TaskType.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _task_type_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
        ...
        # process the form parameters
        # process the body parameter
        if task_type_update_request is not None:
            _body_params = task_type_update_request
