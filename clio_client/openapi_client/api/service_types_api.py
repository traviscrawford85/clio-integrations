...
class ServiceTypesApi:
    ...
    def service_type_index(
        ...
        created_since: Annotated[datetime | None, Field(description="Filter ServiceType records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        ...
        ids: Annotated[StrictInt | None, Field(description="Filter ServiceType records to those having the specified unique identifiers.")] = None,
        limit: Annotated[StrictInt | None, Field(description="A limit on the number of ServiceType records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        order: Annotated[StrictStr | None, Field(description="Orders the ServiceType records by the given field. Default: `id(asc)`.")] = None,
        page_token: Annotated[StrictStr | None, Field(description="A token specifying which page to return.")] = None,
        updated_since: Annotated[datetime | None, Field(description="Filter ServiceType records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
