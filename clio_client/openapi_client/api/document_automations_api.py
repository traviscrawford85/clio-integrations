...
from clio_client.openapi_client.models.document_automation_create_request import \
    DocumentAutomationCreateRequest
from clio_client.openapi_client.models.document_automation_list import \
    DocumentAutomationList
from clio_client.openapi_client.models.document_automation_show import \
...
class DocumentAutomationsApi:
    ...
    @validate_call
    def document_automation_create(
        self,
        ...
        document_automation_create_request: Annotated[Optional[DocumentAutomationCreateRequest], Field(description="Request Body for Document Automations")] = None,
        ...
        _param = self._document_automation_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            document_automation_create_request=document_automation_create_request,
    ...
    def document_automation_create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DocumentAutomationShow]:
        """Create a new DocumentAutomation
    ...
    @validate_call
    def document_automation_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        document_automation_create_request: Annotated[Optional[DocumentAutomationCreateRequest], Field(description="Request Body for Document Automations")] = None,
    ...
    def _document_automation_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if document_automation_create_request is not None:
            _body_params = document_automation_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/document_automations.json',
    ...
    def document_automation_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter DocumentAutomation records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter DocumentAutomation records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of DocumentAutomation records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the DocumentAutomation records by the given field. Default: `id(asc)`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter DocumentAutomation records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._document_automation_index_serialize(
            x_api_version=x_api_version,
    ...
    def document_automation_index_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DocumentAutomationList]:
        """Return the data for all DocumentAutomations
    ...
    @validate_call
    def document_automation_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter DocumentAutomation records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    def _document_automation_index_serialize(
        self,
        x_api_version,
        created_since,
        fields,
    ...
    def document_automation_show(
        ...
        _param = self._document_automation_show_serialize(
            id=id,
    ...
    @validate_call
    def document_automation_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentAutomation.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _document_automation_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/document_automations/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
