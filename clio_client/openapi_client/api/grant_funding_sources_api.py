...
from clio_client.openapi_client.models.grant_funding_source_create_request import (
    GrantFundingSourceCreateRequest,
)
from clio_client.openapi_client.models.grant_funding_source_list import (
    GrantFundingSourceList,
)
from clio_client.openapi_client.models.grant_funding_source_show import (
    ApiResponse,
...
class GrantFundingSourcesApi:
    ...
    @validate_call
    def grant_funding_source_create(
        self,
        ...
        grant_funding_source_create_request: Annotated[Optional[GrantFundingSourceCreateRequest], Field(description="Request Body for Grant Funding Sources")] = None,
        ...
        _param = self._grant_funding_source_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            grant_funding_source_create_request=grant_funding_source_create_request,
    ...
    @validate_call
    def grant_funding_source_create_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        grant_funding_source_create_request: Annotated[Optional[GrantFundingSourceCreateRequest], Field(description="Request Body for Grant Funding Sources")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GrantFundingSourceShow]:
        """Create a new grant funding source
    ...
    @validate_call
    def grant_funding_source_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        grant_funding_source_create_request: Annotated[Optional[GrantFundingSourceCreateRequest], Field(description="Request Body for Grant Funding Sources")] = None,
    ...
    def _grant_funding_source_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if grant_funding_source_create_request is not None:
            _body_params = grant_funding_source_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/grant_funding_sources.json',
    ...
    @validate_call
    def grant_funding_source_destroy(
        self,
        ...
        _param = self._grant_funding_source_destroy_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
    ...
    @validate_call
    def grant_funding_source_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the GrantFundingSource.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _grant_funding_source_destroy_serialize(
        self,
        id,
        if_match,
        x_api_version,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/grant_funding_sources/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def grant_funding_source_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter GrantFundingSource records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter GrantFundingSource records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of GrantFundingSource records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Filter GrantFundingSource records to those that match the given name.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter GrantFundingSource records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._grant_funding_source_index_serialize(
            x_api_version=x_api_version,
    ...
    def grant_funding_source_index_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GrantFundingSourceList]:
        """Return the data for all grant funding sources
    ...
    @validate_call
    def grant_funding_source_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter GrantFundingSource records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    def _grant_funding_source_index_serialize(
        self,
        x_api_version,
        created_since,
        fields,
    ...
    @validate_call
    def grant_funding_source_update(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the GrantFundingSource.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        ...
        _param = self._grant_funding_source_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
    ...
    @validate_call
    def grant_funding_source_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the GrantFundingSource.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _grant_funding_source_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
