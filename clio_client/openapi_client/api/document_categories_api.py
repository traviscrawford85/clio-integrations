...
from clio_client.openapi_client.models.document_category_create_request import \
    DocumentCategoryCreateRequest
from clio_client.openapi_client.models.document_category_list import \
    DocumentCategoryList
from clio_client.openapi_client.models.document_category_show import \
    DocumentCategoryShow
from clio_client.openapi_client.models.document_category_update_request import \
...
class DocumentCategoriesApi:
    ...
    def document_category_create(
        ...
        document_category_create_request: Annotated[Optional[DocumentCategoryCreateRequest], Field(description="Request Body for Document Categories")] = None,
        ...
        _param = self._document_category_create_serialize(
    ...
    def document_category_create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DocumentCategoryShow]:
        """Create a new DocumentCategory
    ...
    @validate_call
    def document_category_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        document_category_create_request: Annotated[Optional[DocumentCategoryCreateRequest], Field(description="Request Body for Document Categories")] = None,
    ...
    def _document_category_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/document_categories.json',
    ...
    @validate_call
    def document_category_destroy(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentCategory.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._document_category_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def document_category_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentCategory.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def document_category_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentCategory.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def _document_category_destroy_serialize(
        self,
        id,
        x_api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/document_categories/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def document_category_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter DocumentCategory records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter DocumentCategory records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of DocumentCategory records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the DocumentCategory records by the given field. Default: `id(asc)`.")] = None,
        ...
        updated_since: Annotated[Optional[datetime], Field(description="Filter DocumentCategory records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._document_category_index_serialize(
            x_api_version=x_api_version,
    ...
    def document_category_index_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DocumentCategoryList]:
        """Return the data for all DocumentCategories
    ...
    @validate_call
    def document_category_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter DocumentCategory records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    def _document_category_index_serialize(
        self,
        x_api_version,
        created_since,
        fields,
    ...
    def document_category_show(
        ...
        _param = self._document_category_show_serialize(
            id=id,
    ...
    @validate_call
    def document_category_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentCategory.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _document_category_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
    ...
    def document_category_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        document_category_update_request: Annotated[Optional[DocumentCategoryUpdateRequest], Field(description="Request Body for Document Categories")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._document_category_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
    ...
    @validate_call
    def document_category_update_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentCategory.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    @validate_call
    def document_category_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentCategory.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _document_category_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
