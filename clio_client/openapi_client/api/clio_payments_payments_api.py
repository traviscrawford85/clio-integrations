...
class ClioPaymentsPaymentsApi:
    ...
    @validate_call
    def clio_payments_payment_index(
        self,
        ...
        bill_id: Annotated[Optional[StrictInt], Field(description="Filter ClioPaymentsPayment records to those that are allocated to the specified bill.")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="Filter ClioPaymentsPayment records to those that are assigned to the specified contact.")] = None,
        ...
        ids: Annotated[Optional[StrictInt], Field(description="Filter ClioPaymentsPayment records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of ClioPaymentsPayment records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        state: Annotated[Optional[StrictStr], Field(description="Filter ClioPaymentsPayment records to those in a given state.")] = None,
        ...
        _param = self._clio_payments_payment_index_serialize(
    ...
    @validate_call
    def clio_payments_payment_index_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        bill_id: Annotated[Optional[StrictInt], Field(description="Filter ClioPaymentsPayment records to those that are allocated to the specified bill.")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="Filter ClioPaymentsPayment records to those that are assigned to the specified contact.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClioPaymentsPaymentList]:
        """Return the data for all ClioPaymentsPayments
    ...
    @validate_call
    def clio_payments_payment_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        bill_id: Annotated[Optional[StrictInt], Field(description="Filter ClioPaymentsPayment records to those that are allocated to the specified bill.")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="Filter ClioPaymentsPayment records to those that are assigned to the specified contact.")] = None,
    ...
    def _clio_payments_payment_index_serialize(
        self,
        x_api_version,
        bill_id,
        contact_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/clio_payments/payments.json',
    ...
    @validate_call
    def clio_payments_payment_show(
        self,
        ...
        _param = self._clio_payments_payment_show_serialize(
            id=id,
    ...
    @validate_call
    def clio_payments_payment_show_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ClioPaymentsPayment.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClioPaymentsPaymentShow]:
        """Return the data for a single ClioPaymentsPayment
    ...
    @validate_call
    def clio_payments_payment_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ClioPaymentsPayment.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _clio_payments_payment_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/clio_payments/payments/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
