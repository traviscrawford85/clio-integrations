...
from clio_client.openapi_client.models.note_create_request import \
    NoteCreateRequest
...
from clio_client.openapi_client.models.note_update_request import \
...
class NotesApi:
    ...
    def note_create(
        ...
        note_create_request: Annotated[Optional[NoteCreateRequest], Field(description="Request Body for Notes")] = None,
        ...
        _param = self._note_create_serialize(
    ...
    @validate_call
    def note_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        note_create_request: Annotated[Optional[NoteCreateRequest], Field(description="Request Body for Notes")] = None,
    ...
    def _note_create_serialize(
        ...
        if note_create_request is not None:
            _body_params = note_create_request
    ...
    def note_destroy(
        ...
        _param = self._note_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def note_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Note.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def note_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Note.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def note_index(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. The keyword `null` is not valid for this field. The list will be filtered to include only the Note records with the matching property.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter Note records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        has_time_entries: Annotated[Optional[StrictBool], Field(description="Filter Note records to those with or without associated time entries.")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter Note records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of Note records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        matter_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Matter. The keyword `null` is not valid for this field. The list will be filtered to include only the Note records with the matching property.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the Note records by the given field. Default: `id(asc)`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Wildcard search across note subject and detail.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter Note records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._note_index_serialize(
            type=type,
            x_api_version=x_api_version,
    ...
    @validate_call
    def note_index_without_preload_content(
        self,
        type: Annotated[StrictStr, Field(description="Filter Note records to those of the specified type.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. The keyword `null` is not valid for this field. The list will be filtered to include only the Note records with the matching property.")] = None,
    ...
    def _note_index_serialize(
        ...
        if has_time_entries is not None:
            ...
            _query_params.append(('has_time_entries', has_time_entries))
    ...
    def note_show(
        ...
        _param = self._note_show_serialize(
            id=id,
    ...
    @validate_call
    def note_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Note.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def note_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        note_update_request: Annotated[Optional[NoteUpdateRequest], Field(description="Request Body for Notes")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _note_update_serialize(
        ...
        if note_update_request is not None:
            _body_params = note_update_request
