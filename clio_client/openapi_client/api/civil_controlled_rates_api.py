...
from clio_client.openapi_client.models.lauk_civil_controlled_rate_list import (
    ApiResponse,
...
class CivilControlledRatesApi:
    ...
    def lauk_civil_controlled_rate_index(
        ...
        matter_type_1: Annotated[Optional[StrictInt], Field(description="Filter by matter type 1.")] = None,
        matter_type_2: Annotated[Optional[StrictInt], Field(description="Filter by matter type 2.")] = None,
        ...
        :type limit: int
        :param matter_type_1: Filter by matter type 1.
        :type matter_type_1: int
        :param matter_type_2: Filter by matter type 2.
    ...
    def _lauk_civil_controlled_rate_index_serialize(
        ...
        if matter_type_1 is not None:
            
            _query_params.append(('matter_type_1', matter_type_1))
            
        if matter_type_2 is not None:
            
            _query_params.append(('matter_type_2', matter_type_2))
