...
from clio_client.openapi_client.models.text_snippet_create_request import (
...
from clio_client.openapi_client.models.text_snippet_update_request import (
    ApiResponse,
...
class TextSnippetsApi:
    ...
    def text_snippet_create(
        ...
        text_snippet_create_request: Annotated[Optional[TextSnippetCreateRequest], Field(description="Request Body for Text Snippets")] = None,
        ...
        _param = self._text_snippet_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            text_snippet_create_request=text_snippet_create_request,
    ...
    @validate_call
    def text_snippet_create_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        text_snippet_create_request: Annotated[Optional[TextSnippetCreateRequest], Field(description="Request Body for Text Snippets")] = None,
    ...
    @validate_call
    def text_snippet_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        text_snippet_create_request: Annotated[Optional[TextSnippetCreateRequest], Field(description="Request Body for Text Snippets")] = None,
    ...
    def _text_snippet_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if text_snippet_create_request is not None:
            _body_params = text_snippet_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/settings/text_snippets.json',
    ...
    def text_snippet_destroy(
        ...
        _param = self._text_snippet_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def text_snippet_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TextSnippet.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def text_snippet_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TextSnippet.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def _text_snippet_destroy_serialize(
        self,
        id,
        x_api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/settings/text_snippets/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def text_snippet_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter TextSnippet records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter TextSnippet records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of TextSnippet records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the TextSnippet records by the given field. Default: `id(asc)`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Wildcard search for `snippet` or `phrase` matching a given string.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter TextSnippet records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._text_snippet_index_serialize(
            x_api_version=x_api_version,
    ...
    @validate_call
    def text_snippet_index_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter TextSnippet records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    @validate_call
    def text_snippet_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter TextSnippet records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    def _text_snippet_index_serialize(
        self,
        x_api_version,
        created_since,
        fields,
    ...
    def text_snippet_show(
        ...
        _param = self._text_snippet_show_serialize(
            id=id,
    ...
    @validate_call
    def text_snippet_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TextSnippet.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _text_snippet_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
    ...
    def text_snippet_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        text_snippet_update_request: Annotated[Optional[TextSnippetUpdateRequest], Field(description="Request Body for Text Snippets")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._text_snippet_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            text_snippet_update_request=text_snippet_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def text_snippet_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TextSnippet.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _text_snippet_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
        ...
        # process the form parameters
        # process the body parameter
        if text_snippet_update_request is not None:
            _body_params = text_snippet_update_request
