...
from clio_client.openapi_client.models.interest_charge_list import (
    ApiResponse,
...
class InterestChargesApi:
    ...
    def interest_charge_destroy(
        ...
        _param = self._interest_charge_destroy_serialize(
            id=id,
    ...
    @validate_call
    def interest_charge_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the InterestCharge.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def interest_charge_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the InterestCharge.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def _interest_charge_destroy_serialize(
        self,
        id,
        x_api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/interest_charges/{id}.json',
    ...
    @validate_call
    def interest_charge_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        bill_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Bill. The keyword `null` is not valid for this field. The list will be filtered to include only the InterestCharge records with the matching property.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter InterestCharge records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        exclude_ids: Annotated[Optional[StrictInt], Field(description="Array containing *InterestCharge* identifiers that should be excluded from the query.")] = None,
        ...
        ids: Annotated[Optional[StrictInt], Field(description="Filter InterestCharge records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of InterestCharge records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter InterestCharge records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._interest_charge_index_serialize(
            x_api_version=x_api_version,
            bill_id=bill_id,
    ...
    def interest_charge_index_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InterestChargeList]:
        """Return the data for all InterestCharges
    ...
    @validate_call
    def interest_charge_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        bill_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Bill. The keyword `null` is not valid for this field. The list will be filtered to include only the InterestCharge records with the matching property.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter InterestCharge records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
    ...
    def _interest_charge_index_serialize(
        self,
        x_api_version,
        bill_id,
        created_since,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/interest_charges.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
