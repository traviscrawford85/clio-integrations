...
from clio_client.openapi_client.models.custom_field_create_request import \
...
from clio_client.openapi_client.models.custom_field_update_request import \
...
class CustomFieldsApi:
    ...
    def custom_field_create(
        ...
        custom_field_create_request: Annotated[Optional[CustomFieldCreateRequest], Field(description="Request Body for Custom Fields")] = None,
        ...
        _param = self._custom_field_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            custom_field_create_request=custom_field_create_request,
    ...
    @validate_call
    def custom_field_create_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        custom_field_create_request: Annotated[Optional[CustomFieldCreateRequest], Field(description="Request Body for Custom Fields")] = None,
    ...
    @validate_call
    def custom_field_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        custom_field_create_request: Annotated[Optional[CustomFieldCreateRequest], Field(description="Request Body for Custom Fields")] = None,
    ...
    def _custom_field_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if custom_field_create_request is not None:
            _body_params = custom_field_create_request
    ...
    def custom_field_destroy(
        ...
        _param = self._custom_field_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def custom_field_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CustomField.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def custom_field_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CustomField.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def _custom_field_destroy_serialize(
        self,
        id,
        x_api_version,
        _request_auth,
    ...
    def custom_field_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter CustomField records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        deleted: Annotated[Optional[StrictBool], Field(description="Filter CustomField records to those that have been deleted for future use.")] = None,
        field_type: Annotated[Optional[StrictStr], Field(description="Field type of this custom field")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter CustomField records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of CustomField records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the CustomField records by the given field. Default: `id(asc)`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        parent_type: Annotated[Optional[StrictStr], Field(description="Filter CustomField records to those that have the specified `parent_type`.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Wildcard search for `name` matching a given string.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter CustomField records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        visible_and_required: Annotated[Optional[StrictBool], Field(description="Filter CustomField records to those that are visible and required.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._custom_field_index_serialize(
            x_api_version=x_api_version,
    ...
    @validate_call
    def custom_field_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter CustomField records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        deleted: Annotated[Optional[StrictBool], Field(description="Filter CustomField records to those that have been deleted for future use.")] = None,
    ...
    def _custom_field_index_serialize(
        self,
        x_api_version,
        created_since,
        deleted,
        ...
        if field_type is not None:
            ...
            _query_params.append(('field_type', field_type))
        ...
        if visible_and_required is not None:
            
            _query_params.append(('visible_and_required', visible_and_required))
    ...
    def custom_field_show(
        ...
        _param = self._custom_field_show_serialize(
            id=id,
    ...
    @validate_call
    def custom_field_show_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CustomField.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    @validate_call
    def custom_field_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CustomField.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _custom_field_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
    ...
    def custom_field_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        custom_field_update_request: Annotated[Optional[CustomFieldUpdateRequest], Field(description="Request Body for Custom Fields")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._custom_field_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            custom_field_update_request=custom_field_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def custom_field_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CustomField.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _custom_field_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
        ...
        # process the form parameters
        # process the body parameter
        if custom_field_update_request is not None:
            _body_params = custom_field_update_request
