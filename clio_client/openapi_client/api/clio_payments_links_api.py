...
from clio_client.openapi_client.models.clio_payments_link_create_request import \
    ClioPaymentsLinkCreateRequest
from clio_client.openapi_client.models.clio_payments_link_list import \
    ClioPaymentsLinkList
from clio_client.openapi_client.models.clio_payments_link_show import \
    ClioPaymentsLinkShow
from clio_client.openapi_client.models.clio_payments_link_update_request import \
...
class ClioPaymentsLinksApi:
    ...
    def clio_payments_link_create(
        ...
        clio_payments_link_create_request: Annotated[Optional[ClioPaymentsLinkCreateRequest], Field(description="Request Body for Links")] = None,
        ...
        _param = self._clio_payments_link_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            clio_payments_link_create_request=clio_payments_link_create_request,
    ...
    @validate_call
    def clio_payments_link_create_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        clio_payments_link_create_request: Annotated[Optional[ClioPaymentsLinkCreateRequest], Field(description="Request Body for Links")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClioPaymentsLinkShow]:
        """Create a new ClioPaymentsLink
    ...
    @validate_call
    def clio_payments_link_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        clio_payments_link_create_request: Annotated[Optional[ClioPaymentsLinkCreateRequest], Field(description="Request Body for Links")] = None,
    ...
    def _clio_payments_link_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if clio_payments_link_create_request is not None:
            _body_params = clio_payments_link_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/clio_payments/links.json',
    ...
    @validate_call
    def clio_payments_link_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        active: Annotated[Optional[StrictBool], Field(description="Filter ClioPaymentsLink records based on whether or not they have expired.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter ClioPaymentsLink records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter ClioPaymentsLink records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of ClioPaymentsLink records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter ClioPaymentsLink records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._clio_payments_link_index_serialize(
            x_api_version=x_api_version,
            active=active,
    ...
    @validate_call
    def clio_payments_link_index_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        active: Annotated[Optional[StrictBool], Field(description="Filter ClioPaymentsLink records based on whether or not they have expired.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter ClioPaymentsLink records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClioPaymentsLinkList]:
        """Return the data for all ClioPaymentsLinks
    ...
    @validate_call
    def clio_payments_link_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        active: Annotated[Optional[StrictBool], Field(description="Filter ClioPaymentsLink records based on whether or not they have expired.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter ClioPaymentsLink records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
    ...
    def _clio_payments_link_index_serialize(
        self,
        x_api_version,
        active,
        created_since,
    ...
    def clio_payments_link_show(
        ...
        _param = self._clio_payments_link_show_serialize(
            id=id,
    ...
    @validate_call
    def clio_payments_link_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ClioPaymentsLink.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _clio_payments_link_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/clio_payments/links/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def clio_payments_link_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        clio_payments_link_update_request: Annotated[Optional[ClioPaymentsLinkUpdateRequest], Field(description="Request Body for Links")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._clio_payments_link_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            clio_payments_link_update_request=clio_payments_link_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def clio_payments_link_update_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ClioPaymentsLink.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    @validate_call
    def clio_payments_link_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ClioPaymentsLink.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _clio_payments_link_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
        ...
        # process the form parameters
        # process the body parameter
        if clio_payments_link_update_request is not None:
            _body_params = clio_payments_link_update_request
