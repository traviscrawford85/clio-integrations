...
from clio_client.openapi_client.models.document_archive_create_request import \
    DocumentArchiveCreateRequest
from clio_client.openapi_client.models.document_archive_show import \
...
class DocumentArchivesApi:
    ...
    def document_archive_create(
        ...
        document_archive_create_request: Annotated[Optional[DocumentArchiveCreateRequest], Field(description="Request Body for Document Archives")] = None,
        ...
        _param = self._document_archive_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            document_archive_create_request=document_archive_create_request,
    ...
    @validate_call
    def document_archive_create_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        document_archive_create_request: Annotated[Optional[DocumentArchiveCreateRequest], Field(description="Request Body for Document Archives")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DocumentArchiveShow]:
        """Create a new DocumentArchive
    ...
    @validate_call
    def document_archive_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        document_archive_create_request: Annotated[Optional[DocumentArchiveCreateRequest], Field(description="Request Body for Document Archives")] = None,
    ...
    def _document_archive_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if document_archive_create_request is not None:
            _body_params = document_archive_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/document_archives.json',
    ...
    def document_archive_download(
        ...
        _param = self._document_archive_download_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def document_archive_download_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentArchive.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def document_archive_download_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentArchive.")],
        _request_timeout: Union[
            None,
    ...
    def _document_archive_download_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/document_archives/{id}/download.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def document_archive_show(
        ...
        _param = self._document_archive_show_serialize(
            id=id,
    ...
    @validate_call
    def document_archive_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentArchive.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _document_archive_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/document_archives/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
