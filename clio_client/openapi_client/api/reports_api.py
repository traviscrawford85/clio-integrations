...
class ReportsApi:
    ...
    def _report_download_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reports/{id}/download.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def report_index(
        ...
        _param = self._report_index_serialize(
            x_api_version=x_api_version,
            category=category,
    ...
    def report_show(
        ...
        _param = self._report_show_serialize(
            id=id,
