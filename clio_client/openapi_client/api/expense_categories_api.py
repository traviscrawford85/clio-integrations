...
from clio_client.openapi_client.models.expense_category_create_request import \
    ExpenseCategoryCreateRequest
from clio_client.openapi_client.models.expense_category_list import \
    ExpenseCategoryList
from clio_client.openapi_client.models.expense_category_show import \
    ExpenseCategoryShow
from clio_client.openapi_client.models.expense_category_update_request import \
    ExpenseCategoryUpdateRequest
from clio_client.openapi_client.models.lauk_expense_category_list import \
...
class ExpenseCategoriesApi:
    ...
    def expense_category_create(
        ...
        expense_category_create_request: Annotated[Optional[ExpenseCategoryCreateRequest], Field(description="Request Body for Expense Categories")] = None,
        ...
        _param = self._expense_category_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            expense_category_create_request=expense_category_create_request,
    ...
    @validate_call
    def expense_category_create_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        expense_category_create_request: Annotated[Optional[ExpenseCategoryCreateRequest], Field(description="Request Body for Expense Categories")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpenseCategoryShow]:
        """Create a new ExpenseCategory
    ...
    @validate_call
    def expense_category_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        expense_category_create_request: Annotated[Optional[ExpenseCategoryCreateRequest], Field(description="Request Body for Expense Categories")] = None,
    ...
    def _expense_category_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if expense_category_create_request is not None:
            _body_params = expense_category_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/expense_categories.json',
    ...
    def expense_category_destroy(
        ...
        _param = self._expense_category_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def expense_category_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ExpenseCategory.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def expense_category_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ExpenseCategory.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def _expense_category_destroy_serialize(
        self,
        id,
        x_api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/expense_categories/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def expense_category_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter ExpenseCategory records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        entry_type: Annotated[Optional[StrictStr], Field(description="Filter ExpenseCategory records to those that match the given type.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of ExpenseCategory records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the ExpenseCategory records by the given field. Default: `id(asc)`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Allows matching search on expense category name.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter ExpenseCategory records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._expense_category_index_serialize(
            x_api_version=x_api_version,
    ...
    @validate_call
    def expense_category_index_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter ExpenseCategory records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        entry_type: Annotated[Optional[StrictStr], Field(description="Filter ExpenseCategory records to those that match the given type.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpenseCategoryList]:
        """Return the data for all ExpenseCategories
    ...
    @validate_call
    def expense_category_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter ExpenseCategory records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        entry_type: Annotated[Optional[StrictStr], Field(description="Filter ExpenseCategory records to those that match the given type.")] = None,
    ...
    def _expense_category_index_serialize(
        self,
        x_api_version,
        created_since,
        entry_type,
        ...
        if entry_type is not None:
            ...
            _query_params.append(('entry_type', entry_type))
    ...
    def expense_category_show(
        ...
        _param = self._expense_category_show_serialize(
            id=id,
    ...
    @validate_call
    def expense_category_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ExpenseCategory.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _expense_category_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
    ...
    def expense_category_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        expense_category_update_request: Annotated[Optional[ExpenseCategoryUpdateRequest], Field(description="Request Body for Expense Categories")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._expense_category_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            expense_category_update_request=expense_category_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def expense_category_update_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ExpenseCategory.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    @validate_call
    def expense_category_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ExpenseCategory.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _expense_category_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
        ...
        # process the form parameters
        # process the body parameter
        if expense_category_update_request is not None:
            _body_params = expense_category_update_request
    ...
    @validate_call
    def lauk_expense_category_index(
        self,
        ...
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of LaukExpenseCategory records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Filter by expense name.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        practice_area: Annotated[Optional[StrictStr], Field(description="Filter by expense practice area.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._lauk_expense_category_index_serialize(
            region=region,
            x_api_version=x_api_version,
            fields=fields,
            key=key,
    ...
    @validate_call
    def lauk_expense_category_index_with_http_info(
        self,
        region: Annotated[StrictStr, Field(description="Sets the expense rate returned based on the region. If the region is set to London, it will return the London rate; otherwise, it will return the non-London rate.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LaukExpenseCategoryList]:
        """List Expense Categories
    ...
    @validate_call
    def lauk_expense_category_index_without_preload_content(
        self,
        region: Annotated[StrictStr, Field(description="Sets the expense rate returned based on the region. If the region is set to London, it will return the London rate; otherwise, it will return the non-London rate.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    def _lauk_expense_category_index_serialize(
        self,
        region,
        x_api_version,
        fields,
        ...
        if practice_area is not None:
            ...
            _query_params.append(('practice_area', practice_area))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/lauk_expense_categories.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
