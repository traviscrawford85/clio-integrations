...
from clio_client.openapi_client.models.matter_contacts_list import \
...
class MatterContactsApi:
    ...
    def matter_contacts_index(
        ...
        custom_field_ids: Annotated[Optional[StrictInt], Field(description="IDs of custom fields to include in results.")] = None,
        ...
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of MatterContacts records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the MatterContacts records by the given field. Note that `id` is ordered by the `id` of the nested Relationship record. Default: `is_client(asc)`.")] = None,
        ...
        _param = self._matter_contacts_index_serialize(
            matter_id=matter_id,
    ...
    @validate_call
    def matter_contacts_index_with_http_info(
        self,
        matter_id: Annotated[StrictInt, Field(description="Filters contact data by matter.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        custom_field_ids: Annotated[Optional[StrictInt], Field(description="IDs of custom fields to include in results.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MatterContactsList]:
        """Return the related contact data for a single matter
    ...
    @validate_call
    def matter_contacts_index_without_preload_content(
        self,
        matter_id: Annotated[StrictInt, Field(description="Filters contact data by matter.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        custom_field_ids: Annotated[Optional[StrictInt], Field(description="IDs of custom fields to include in results.")] = None,
    ...
    def _matter_contacts_index_serialize(
        self,
        matter_id,
        x_api_version,
        custom_field_ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/matters/{matter_id}/contacts.json',
