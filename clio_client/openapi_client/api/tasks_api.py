...
from clio_client.openapi_client.models.task_create_request import \
    TaskCreateRequest
...
from clio_client.openapi_client.models.task_update_request import \
...
class TasksApi:
    ...
    def task_create(
        ...
        task_create_request: Annotated[Optional[TaskCreateRequest], Field(description="Request Body for Tasks")] = None,
        ...
        _param = self._task_create_serialize(
    ...
    @validate_call
    def task_create_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        task_create_request: Annotated[Optional[TaskCreateRequest], Field(description="Request Body for Tasks")] = None,
    ...
    @validate_call
    def task_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        task_create_request: Annotated[Optional[TaskCreateRequest], Field(description="Request Body for Tasks")] = None,
    ...
    def task_destroy(
        ...
        _param = self._task_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def task_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Task.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def task_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Task.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def task_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        assignee_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User or Contact. Use the keyword `null` to match those without a Task. The list will be filtered to include only the Task records with the matching property.")] = None,
        assignee_type: Annotated[Optional[StrictStr], Field(description="Filter Task records to those with a specific assignee. Must be passed if filtering by assignee.")] = None,
        assigner_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User. Use the keyword `null` to match those without a Task. The list will be filtered to include only the Task records with the matching property.")] = None,
        cascading_source_id: Annotated[Optional[StrictInt], Field(description="Filter Task records to those with a parent task that has the specified ID.")] = None,
        client_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. Use the keyword `null` to match those without a Task. The list will be filtered to include only the Task records with the matching property.")] = None,
        complete: Annotated[Optional[StrictBool], Field(description="Filter Task records to those which are complete or not.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter Task records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        due_at_from: Annotated[Optional[date], Field(description="Start of date range when querying by due_at in a range. (Expects an ISO-8601 date).")] = None,
        due_at_present: Annotated[Optional[StrictBool], Field(description="Filter Task records to those that have a due date specified, or not.")] = None,
        due_at_to: Annotated[Optional[date], Field(description="End of date range when querying by due_at in a range. (Expects an ISO-8601 date).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter Task records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of Task records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        matter_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Matter. Use the keyword `null` to match those without a Task. The list will be filtered to include only the Task records with the matching property.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the Task records by the given field. Default: `id(asc)`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        permission: Annotated[Optional[StrictStr], Field(description="Filter Task records to those with the given permission. Returns all tasks by default.")] = None,
        priority: Annotated[Optional[StrictStr], Field(description="Filter Task records to those with the given priority.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Wildcard search for `name` or `description` matching a given string.")] = None,
        responsible_attorney_id: Annotated[Optional[StrictInt], Field(description="Filter Task records to those that have an associated matter with a responsible attorney ID.")] = None,
        status: Annotated[Optional[StrictStr], Field(description="Filter Task records to those with the given status. Users without advanced tasks enabled may only specify 'complete' or 'pending'.")] = None,
        statuses: Annotated[Optional[StrictStr], Field(description="Filter Task records to those with the given statuses. Users without advanced tasks enabled may only specify 'complete' or 'pending'.")] = None,
        statute_of_limitations: Annotated[Optional[StrictBool], Field(description="Filter Task records to those which are a statute of limitations or not.")] = None,
        task_type_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single TaskType. Use the keyword `null` to match those without a Task. The list will be filtered to include only the Task records with the matching property.")] = None,
        time_entries_present: Annotated[Optional[StrictBool], Field(description="Filter Task records to those that have associated time entries, or not.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter Task records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._task_index_serialize(
            x_api_version=x_api_version,
    ...
    @validate_call
    def task_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        assignee_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User or Contact. Use the keyword `null` to match those without a Task. The list will be filtered to include only the Task records with the matching property.")] = None,
        assignee_type: Annotated[Optional[StrictStr], Field(description="Filter Task records to those with a specific assignee. Must be passed if filtering by assignee.")] = None,
    ...
    def _task_index_serialize(
        ...
        if assignee_id is not None:
            ...
            _query_params.append(('assignee_id', assignee_id))
        ...
        if assigner_id is not None:
            ...
            _query_params.append(('assigner_id', assigner_id))
            
        if cascading_source_id is not None:
            
            _query_params.append(('cascading_source_id', cascading_source_id))
        ...
        if due_at_from is not None:
            if isinstance(due_at_from, date):
                _query_params.append(
                    (
                        'due_at_from',
                ...
                _query_params.append(('due_at_from', due_at_from))
            
        if due_at_present is not None:
            
            _query_params.append(('due_at_present', due_at_present))
            
        if due_at_to is not None:
            if isinstance(due_at_to, date):
                _query_params.append(
                    (
                        'due_at_to',
                        due_at_to.strftime(
                ...
                _query_params.append(('due_at_to', due_at_to))
        ...
        if statute_of_limitations is not None:
            
            _query_params.append(('statute_of_limitations', statute_of_limitations))
            
        if task_type_id is not None:
            
            _query_params.append(('task_type_id', task_type_id))
            
        if time_entries_present is not None:
            
            _query_params.append(('time_entries_present', time_entries_present))
    ...
    def task_show(
        ...
        _param = self._task_show_serialize(
            id=id,
    ...
    @validate_call
    def task_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Task.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def task_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        task_update_request: Annotated[Optional[TaskUpdateRequest], Field(description="Request Body for Tasks")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
