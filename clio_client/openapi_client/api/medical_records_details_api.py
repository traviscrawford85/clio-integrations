...
from clio_client.openapi_client.models.medical_records_request_create_request import \
    MedicalRecordsRequestCreateRequest
from clio_client.openapi_client.models.medical_records_request_list import \
    MedicalRecordsRequestList
from clio_client.openapi_client.models.medical_records_request_show import \
    MedicalRecordsRequestShow
from clio_client.openapi_client.models.medical_records_request_update_request import \
...
class MedicalRecordsDetailsApi:
    ...
    @validate_call
    def medical_records_request_create(
        self,
        ...
        medical_records_request_create_request: Annotated[Optional[MedicalRecordsRequestCreateRequest], Field(description="Request Body for Medical Records Details")] = None,
        ...
        _param = self._medical_records_request_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            medical_records_request_create_request=medical_records_request_create_request,
    ...
    @validate_call
    def medical_records_request_create_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        medical_records_request_create_request: Annotated[Optional[MedicalRecordsRequestCreateRequest], Field(description="Request Body for Medical Records Details")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MedicalRecordsRequestShow]:
        """Creating a Medical Records Detail, Medical Records and Medical Bills
    ...
    @validate_call
    def medical_records_request_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        medical_records_request_create_request: Annotated[Optional[MedicalRecordsRequestCreateRequest], Field(description="Request Body for Medical Records Details")] = None,
    ...
    def _medical_records_request_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if medical_records_request_create_request is not None:
            _body_params = medical_records_request_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/medical_records_details.json',
    ...
    @validate_call
    def medical_records_request_destroy(
        self,
        ...
        _param = self._medical_records_request_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def medical_records_request_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Medical Records Detail.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def medical_records_request_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Medical Records Detail.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def _medical_records_request_destroy_serialize(
        self,
        id,
        x_api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/medical_records_details/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def medical_records_request_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter MedicalRecordsRequest records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter MedicalRecordsRequest records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of Medical Records Detail records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        treatment_end_date: Annotated[Optional[datetime], Field(description="Filters Medical Records data by treatment end date.")] = None,
        treatment_start_date: Annotated[Optional[datetime], Field(description="Filters Medical Records data by treatment start date.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter MedicalRecordsRequest records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._medical_records_request_index_serialize(
            x_api_version=x_api_version,
    ...
    @validate_call
    def medical_records_request_index_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter MedicalRecordsRequest records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MedicalRecordsRequestList]:
        """Return the data for all Medical Records Details
    ...
    @validate_call
    def medical_records_request_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter MedicalRecordsRequest records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    def _medical_records_request_index_serialize(
        self,
        x_api_version,
        created_since,
        fields,
        ...
        if treatment_end_date is not None:
            if isinstance(treatment_end_date, datetime):
                _query_params.append(
                    (
                        'treatment_end_date',
                        treatment_end_date.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('treatment_end_date', treatment_end_date))
            
        if treatment_start_date is not None:
            if isinstance(treatment_start_date, datetime):
                _query_params.append(
                    (
                        'treatment_start_date',
                        treatment_start_date.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('treatment_start_date', treatment_start_date))
    ...
    @validate_call
    def medical_records_request_show(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Medical Records Detail.")],
        ...
        _param = self._medical_records_request_show_serialize(
            id=id,
    ...
    @validate_call
    def medical_records_request_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Medical Records Detail.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _medical_records_request_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
    ...
    @validate_call
    def medical_records_request_update(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Medical Records Detail.")],
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        medical_records_request_update_request: Annotated[Optional[MedicalRecordsRequestUpdateRequest], Field(description="Request Body for Medical Records Details")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._medical_records_request_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            medical_records_request_update_request=medical_records_request_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def medical_records_request_update_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Medical Records Detail.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    @validate_call
    def medical_records_request_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Medical Records Detail.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _medical_records_request_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
        ...
        # process the form parameters
        # process the body parameter
        if medical_records_request_update_request is not None:
            _body_params = medical_records_request_update_request
