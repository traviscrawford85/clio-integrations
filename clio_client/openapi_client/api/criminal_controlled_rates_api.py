...
from clio_client.openapi_client.models.lauk_criminal_controlled_rate_list import \
...
class CriminalControlledRatesApi:
    ...
    def lauk_criminal_controlled_rate_index(
        ...
        standard_fee_category: Annotated[Optional[StrictStr], Field(description="Filter by standard fee category.")] = None,
        ...
        :param standard_fee_category: Filter by standard fee category.
        :type standard_fee_category: str
    ...
    def _lauk_criminal_controlled_rate_index_serialize(
        ...
        if standard_fee_category is not None:
            
            _query_params.append(('standard_fee_category', standard_fee_category))
