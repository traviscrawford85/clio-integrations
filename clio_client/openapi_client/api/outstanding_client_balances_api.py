...
from clio_client.openapi_client.models.outstanding_client_balance_list import (
    ApiResponse,
...
class OutstandingClientBalancesApi:
    ...
    def outstanding_client_balance_index(
        ...
        contact_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. Use the keyword `null` to match those without a OutstandingClientBalance. The list will be filtered to include only the OutstandingClientBalance records with the matching property.")] = None,
        ...
        last_paid_end_date: Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for those whose bills have been paid before the specified date")] = None,
        last_paid_start_date: Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for those whose bills have been paid after the specified date")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of OutstandingClientBalance records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        newest_bill_due_end_date: Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for the contact's newest bill due date before the specified date")] = None,
        newest_bill_due_start_date: Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for the contact's newest bill due date after the specified date")] = None,
        originating_attorney_id: Annotated[Optional[StrictInt], Field(description="Filters OutstandingClientBalance records to those with matters that have a matching originating attorney.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        responsible_attorney_id: Annotated[Optional[StrictInt], Field(description="Filter OutstandingClientBalance records to those with matters that have a matching responsible attorney")] = None,
        ...
        _param = self._outstanding_client_balance_index_serialize(
    ...
    def outstanding_client_balance_index_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OutstandingClientBalanceList]:
        """Return the data for all OutstandingClientBalances
    ...
    @validate_call
    def outstanding_client_balance_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. Use the keyword `null` to match those without a OutstandingClientBalance. The list will be filtered to include only the OutstandingClientBalance records with the matching property.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    def _outstanding_client_balance_index_serialize(
        self,
        x_api_version,
        contact_id,
        fields,
        ...
        if last_paid_end_date is not None:
            if isinstance(last_paid_end_date, date):
                _query_params.append(
                    (
                        'last_paid_end_date',
                        last_paid_end_date.strftime(
                            self.api_client.configuration.date_format
                        )
                    )
                )
            else:
                _query_params.append(('last_paid_end_date', last_paid_end_date))
            
        if last_paid_start_date is not None:
            if isinstance(last_paid_start_date, date):
                _query_params.append(
                    (
                        'last_paid_start_date',
                        last_paid_start_date.strftime(
                            self.api_client.configuration.date_format
                        )
                    )
                )
            else:
                _query_params.append(('last_paid_start_date', last_paid_start_date))
            
        if limit is not None:
            
            _query_params.append(('limit', limit))
            
        if newest_bill_due_end_date is not None:
            if isinstance(newest_bill_due_end_date, date):
                _query_params.append(
                    (
                        'newest_bill_due_end_date',
                        newest_bill_due_end_date.strftime(
                            self.api_client.configuration.date_format
                        )
                    )
                )
            else:
                _query_params.append(('newest_bill_due_end_date', newest_bill_due_end_date))
            
        if newest_bill_due_start_date is not None:
            if isinstance(newest_bill_due_start_date, date):
                _query_params.append(
                    (
                        'newest_bill_due_start_date',
                        newest_bill_due_start_date.strftime(
                            self.api_client.configuration.date_format
                        )
                    )
                )
            else:
                _query_params.append(('newest_bill_due_start_date', newest_bill_due_start_date))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/outstanding_client_balances.json',
