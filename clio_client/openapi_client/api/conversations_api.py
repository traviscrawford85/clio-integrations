...
from clio_client.openapi_client.models.conversation_list import \
    ConversationList
from clio_client.openapi_client.models.conversation_show import \
    ConversationShow
from clio_client.openapi_client.models.conversation_update_request import \
...
class ConversationsApi:
    ...
    def conversation_index(
        ...
        archived: Annotated[Optional[StrictBool], Field(description="Filter archived Conversation records.")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="Filter Conversation records for the contact.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter Conversation records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        var_date: Annotated[Optional[date], Field(description="Filter Conversation records created on a given date. (Expects an ISO-8601 date).")] = None,
        ...
        for_user: Annotated[Optional[StrictBool], Field(description="If set to true, filter Conversation records accessible to any groups of the user. Note that the user may not be member of the conversations.  If set to false, filter Conversation records of which the user is a member. ")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter Conversation records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of Conversation records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        matter_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Matter. Use the keyword `null` to match those without a Conversation. The list will be filtered to include only the Conversation records with the matching property.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the Conversation records by the given field. Default: `id(asc)`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        read_status: Annotated[Optional[StrictBool], Field(description="Filter Conversation records to those which have been read.")] = None,
        time_entries: Annotated[Optional[StrictBool], Field(description="Filter Conversation records to those with or without associated time entries.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter Conversation records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        ...
        _param = self._conversation_index_serialize(
    ...
    @validate_call
    def conversation_index_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        archived: Annotated[Optional[StrictBool], Field(description="Filter archived Conversation records.")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="Filter Conversation records for the contact.")] = None,
    ...
    @validate_call
    def conversation_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        archived: Annotated[Optional[StrictBool], Field(description="Filter archived Conversation records.")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="Filter Conversation records for the contact.")] = None,
    ...
    def _conversation_index_serialize(
        self,
        x_api_version,
        archived,
        contact_id,
        ...
        if time_entries is not None:
            ...
            _query_params.append(('time_entries', time_entries))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/conversations.json',
    ...
    def conversation_show(
        ...
        _param = self._conversation_show_serialize(
            id=id,
    ...
    @validate_call
    def conversation_show_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Conversation.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    @validate_call
    def conversation_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Conversation.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _conversation_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/conversations/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def conversation_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        conversation_update_request: Annotated[Optional[ConversationUpdateRequest], Field(description="Request Body for Conversations")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._conversation_update_serialize(
            ...
            x_api_version=x_api_version,
            fields=fields,
            conversation_update_request=conversation_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _conversation_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if conversation_update_request is not None:
            _body_params = conversation_update_request
