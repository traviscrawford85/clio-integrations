...
from clio_client.openapi_client.models.jurisdictions_to_trigger_list import (
    JurisdictionsToTriggerList,
)
from clio_client.openapi_client.models.jurisdictions_to_trigger_show import (
    ApiResponse,
...
class JurisdictionsToTriggersApi:
    ...
    def jurisdictions_to_trigger_index(
        ...
        created_since: Annotated[Optional[datetime], Field(description="Filter JurisdictionsToTrigger records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        ...
        ids: Annotated[Optional[StrictInt], Field(description="Filter JurisdictionsToTrigger records to those having the specified unique identifiers.")] = None,
        is_requirements_required: Annotated[Optional[StrictBool], Field(description="Filter JurisdictionsToTrigger records to those which require addition requirements to be checked (usually specifying trigger time).")] = None,
        is_served: Annotated[Optional[StrictBool], Field(description="Filter JurisdictionsToTrigger records to those which require a service type to be selected.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of JurisdictionsToTrigger records to be returned. Limit can range between 1 and 1000. Default: `1000`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the JurisdictionsToTrigger records by the given field. Default: `id(asc)`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Wildcard search for `description` matching a given string.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter JurisdictionsToTrigger records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        ...
        _param = self._jurisdictions_to_trigger_index_serialize(
    ...
    @validate_call
    def jurisdictions_to_trigger_index_with_http_info(
        self,
        jurisdiction_id: Annotated[StrictInt, Field(description="The unique identifier for the Jurisdiction.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter JurisdictionsToTrigger records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JurisdictionsToTriggerList]:
        """Return the data for all triggers
    ...
    @validate_call
    def jurisdictions_to_trigger_index_without_preload_content(
        self,
        jurisdiction_id: Annotated[StrictInt, Field(description="The unique identifier for the Jurisdiction.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter JurisdictionsToTrigger records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
    ...
    def _jurisdictions_to_trigger_index_serialize(
        self,
        jurisdiction_id,
        x_api_version,
        created_since,
        ...
        if jurisdiction_id is not None:
            _path_params['jurisdiction_id'] = jurisdiction_id
        ...
        if is_requirements_required is not None:
            
            _query_params.append(('is_requirements_required', is_requirements_required))
            
        if is_served is not None:
            
            _query_params.append(('is_served', is_served))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/court_rules/jurisdictions/{jurisdiction_id}/triggers.json',
    ...
    def jurisdictions_to_trigger_show(
        ...
        _param = self._jurisdictions_to_trigger_show_serialize(
            id=id,
            jurisdiction_id=jurisdiction_id,
    ...
    @validate_call
    def jurisdictions_to_trigger_show_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the JurisdictionsToTrigger.")],
        jurisdiction_id: Annotated[StrictInt, Field(description="The unique identifier for the Jurisdiction.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JurisdictionsToTriggerShow]:
        """Return the data for the trigger
    ...
    @validate_call
    def jurisdictions_to_trigger_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the JurisdictionsToTrigger.")],
        jurisdiction_id: Annotated[StrictInt, Field(description="The unique identifier for the Jurisdiction.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
    ...
    def _jurisdictions_to_trigger_show_serialize(
        self,
        id,
        jurisdiction_id,
        if_modified_since,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/court_rules/jurisdictions/{jurisdiction_id}/triggers/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
