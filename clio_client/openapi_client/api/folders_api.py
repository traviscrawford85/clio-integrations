...
class FoldersApi:
    ...
    def folder_create(
        ...
        _param = self._folder_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            folder_create_request=folder_create_request,
    ...
    def _folder_create_serialize(
        ...
        if folder_create_request is not None:
            _body_params = folder_create_request
    ...
    def folder_destroy(
        ...
        _param = self._folder_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def folder_index(
        ...
        _param = self._folder_index_serialize(
            x_api_version=x_api_version,
    ...
    def folder_list(
        ...
        _param = self._folder_list_serialize(
            x_api_version=x_api_version,
            contact_id=contact_id,
            created_since=created_since,
            document_category_id=document_category_id,
    ...
    def _folder_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/folders/list.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def folder_show(
        ...
        _param = self._folder_show_serialize(
            id=id,
    ...
    def folder_update(
        ...
        _param = self._folder_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            folder_update_request=folder_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _folder_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if folder_update_request is not None:
            _body_params = folder_update_request
