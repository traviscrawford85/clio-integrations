...
class MatterStagesApi:
    ...
    def matter_stage_index(
        ...
        created_since: Annotated[datetime | None, Field(description="Filter MatterStage records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        ...
        ids: Annotated[StrictInt | None, Field(description="Filter MatterStage records to those having the specified unique identifiers.")] = None,
        limit: Annotated[StrictInt | None, Field(description="A limit on the number of MatterStage records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        page_token: Annotated[StrictStr | None, Field(description="A token specifying which page to return.")] = None,
        practice_area_id: Annotated[StrictInt | None, Field(description="The unique identifier for a single PracticeArea. The keyword `null` is not valid for this field. The list will be filtered to include only the MatterStage records with the matching property.")] = None,
        updated_since: Annotated[datetime | None, Field(description="Filter MatterStage records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
