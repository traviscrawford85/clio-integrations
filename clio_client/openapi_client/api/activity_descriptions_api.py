...
from clio_client.openapi_client.models.activity_description_create_request import \
    ActivityDescriptionCreateRequest
from clio_client.openapi_client.models.activity_description_list import \
    ActivityDescriptionList
from clio_client.openapi_client.models.activity_description_show import \
    ActivityDescriptionShow
from clio_client.openapi_client.models.activity_description_update_request import \
...
class ActivityDescriptionsApi:
    ...
    @validate_call
    def activity_description_create(
        self,
        ...
        activity_description_create_request: Annotated[Optional[ActivityDescriptionCreateRequest], Field(description="Request Body for Activity Descriptions")] = None,
        ...
        _param = self._activity_description_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            activity_description_create_request=activity_description_create_request,
    ...
    @validate_call
    def activity_description_create_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        activity_description_create_request: Annotated[Optional[ActivityDescriptionCreateRequest], Field(description="Request Body for Activity Descriptions")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ActivityDescriptionShow]:
        """Create a new ActivityDescription
    ...
    @validate_call
    def activity_description_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        activity_description_create_request: Annotated[Optional[ActivityDescriptionCreateRequest], Field(description="Request Body for Activity Descriptions")] = None,
    ...
    def _activity_description_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if activity_description_create_request is not None:
            _body_params = activity_description_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/activity_descriptions.json',
    ...
    @validate_call
    def activity_description_destroy(
        self,
        ...
        _param = self._activity_description_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def activity_description_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ActivityDescription.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def activity_description_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ActivityDescription.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def _activity_description_destroy_serialize(
        self,
        id,
        x_api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/activity_descriptions/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def activity_description_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter ActivityDescription records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        flat_rate: Annotated[Optional[StrictBool], Field(description="Filter ActivityDescription records to those that have a flat rate, or not.")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter ActivityDescription records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of ActivityDescription records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        rate_for_matter_id: Annotated[Optional[StrictInt], Field(description="Matter id for rate calculation.")] = None,
        rate_for_user_id: Annotated[Optional[StrictInt], Field(description="User id for rate calculation. If not provided, the user associated to the API request is assumed.")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Filter ActivityDescription records to those of a specific type.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter ActivityDescription records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        user_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User. The keyword `null` is not valid for this field. The list will be filtered to include only the ActivityDescription records with the matching property.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._activity_description_index_serialize(
            x_api_version=x_api_version,
            ...
            rate_for_matter_id=rate_for_matter_id,
            rate_for_user_id=rate_for_user_id,
            type=type,
    ...
    @validate_call
    def activity_description_index_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter ActivityDescription records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ActivityDescriptionList]:
        """Return the data for all ActivityDescriptions
    ...
    @validate_call
    def activity_description_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter ActivityDescription records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    def _activity_description_index_serialize(
        self,
        x_api_version,
        created_since,
        fields,
        ...
        if rate_for_matter_id is not None:
            
            _query_params.append(('rate_for[matter_id]', rate_for_matter_id))
            
        if rate_for_user_id is not None:
            
            _query_params.append(('rate_for[user_id]', rate_for_user_id))
    ...
    def activity_description_show(
        ...
        _param = self._activity_description_show_serialize(
            id=id,
    ...
    @validate_call
    def activity_description_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ActivityDescription.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _activity_description_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
    ...
    @validate_call
    def activity_description_update(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ActivityDescription.")],
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        activity_description_update_request: Annotated[Optional[ActivityDescriptionUpdateRequest], Field(description="Request Body for Activity Descriptions")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._activity_description_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            activity_description_update_request=activity_description_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def activity_description_update_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ActivityDescription.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    @validate_call
    def activity_description_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ActivityDescription.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _activity_description_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
        ...
        # process the form parameters
        # process the body parameter
        if activity_description_update_request is not None:
            _body_params = activity_description_update_request
