...
class ActivityDescriptionsApi:
    ...
    def activity_description_create(
        ...
        activity_description_create_request: Annotated[ActivityDescriptionCreateRequest | None, Field(description="Request Body for Activity Descriptions")] = None,
    ...
    def activity_description_index(
        self,
        x_api_version: Annotated[StrictStr | None, Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[datetime | None, Field(description="Filter ActivityDescription records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[StrictStr | None, Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        flat_rate: Annotated[StrictBool | None, Field(description="Filter ActivityDescription records to those that have a flat rate, or not.")] = None,
        ids: Annotated[StrictInt | None, Field(description="Filter ActivityDescription records to those having the specified unique identifiers.")] = None,
        limit: Annotated[StrictInt | None, Field(description="A limit on the number of ActivityDescription records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        page_token: Annotated[StrictStr | None, Field(description="A token specifying which page to return.")] = None,
        rate_for_matter_id: Annotated[StrictInt | None, Field(description="Matter id for rate calculation.")] = None,
        rate_for_user_id: Annotated[StrictInt | None, Field(description="User id for rate calculation. If not provided, the user associated to the API request is assumed.")] = None,
        type: Annotated[StrictStr | None, Field(description="Filter ActivityDescription records to those of a specific type.")] = None,
        updated_since: Annotated[datetime | None, Field(description="Filter ActivityDescription records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        user_id: Annotated[StrictInt | None, Field(description="The unique identifier for a single User. The keyword `null` is not valid for this field. The list will be filtered to include only the ActivityDescription records with the matching property.")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    def activity_description_update(
        ...
        x_api_version: Annotated[StrictStr | None, Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[StrictStr | None, Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        activity_description_update_request: Annotated[ActivityDescriptionUpdateRequest | None, Field(description="Request Body for Activity Descriptions")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
