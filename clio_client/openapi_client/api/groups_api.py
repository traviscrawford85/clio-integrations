...
class GroupsApi:
    ...
    def group_destroy(
        ...
        _param = self._group_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def group_index(
        ...
        _param = self._group_index_serialize(
            x_api_version=x_api_version,
            archived=archived,
    ...
    def group_show(
        ...
        _param = self._group_show_serialize(
            id=id,
