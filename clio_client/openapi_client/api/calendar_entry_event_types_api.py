...
class CalendarEntryEventTypesApi:
    ...
    def calendar_entry_event_type_create(
        ...
        calendar_entry_event_type_create_request: Annotated[Optional[CalendarEntryEventTypeCreateRequest], Field(description="Request Body for Calendar Entry Event Types")] = None,
        ...
        _param = self._calendar_entry_event_type_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            calendar_entry_event_type_create_request=calendar_entry_event_type_create_request,
    ...
    def calendar_entry_event_type_create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CalendarEntryEventType]:
        """Create a new calendar entry event type
    ...
    @validate_call
    def calendar_entry_event_type_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        calendar_entry_event_type_create_request: Annotated[Optional[CalendarEntryEventTypeCreateRequest], Field(description="Request Body for Calendar Entry Event Types")] = None,
    ...
    def _calendar_entry_event_type_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if calendar_entry_event_type_create_request is not None:
            _body_params = calendar_entry_event_type_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/calendar_entry_event_types.json',
    ...
    @validate_call
    def calendar_entry_event_type_destroy(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CalendarEntryEventType.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._calendar_entry_event_type_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def calendar_entry_event_type_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CalendarEntryEventType.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def calendar_entry_event_type_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CalendarEntryEventType.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def _calendar_entry_event_type_destroy_serialize(
        self,
        id,
        x_api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/calendar_entry_event_types/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def calendar_entry_event_type_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter CalendarEntryEventType records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter CalendarEntryEventType records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of CalendarEntryEventType records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter CalendarEntryEventType records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._calendar_entry_event_type_index_serialize(
            x_api_version=x_api_version,
    ...
    @validate_call
    def calendar_entry_event_type_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter CalendarEntryEventType records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    def _calendar_entry_event_type_index_serialize(
        self,
        x_api_version,
        created_since,
        fields,
    ...
    @validate_call
    def calendar_entry_event_type_show(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CalendarEntryEventType.")],
        ...
        _param = self._calendar_entry_event_type_show_serialize(
            id=id,
    ...
    @validate_call
    def calendar_entry_event_type_show_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CalendarEntryEventType.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    @validate_call
    def calendar_entry_event_type_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CalendarEntryEventType.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _calendar_entry_event_type_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
    ...
    @validate_call
    def calendar_entry_event_type_update(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CalendarEntryEventType.")],
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        calendar_entry_event_type_update_request: Annotated[Optional[CalendarEntryEventTypeUpdateRequest], Field(description="Request Body for Calendar Entry Event Types")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._calendar_entry_event_type_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            calendar_entry_event_type_update_request=calendar_entry_event_type_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def calendar_entry_event_type_update_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CalendarEntryEventType.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    @validate_call
    def calendar_entry_event_type_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the CalendarEntryEventType.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _calendar_entry_event_type_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
        ...
        # process the form parameters
        # process the body parameter
        if calendar_entry_event_type_update_request is not None:
            _body_params = calendar_entry_event_type_update_request
