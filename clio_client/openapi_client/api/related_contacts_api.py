...
from clio_client.openapi_client.models.related_contacts_list import (
    ApiResponse,
...
class RelatedContactsApi:
    ...
    def related_contacts_index(
        ...
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of RelatedContacts records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the RelatedContacts records by the given field. Note that `id` is ordered by the `id` of the nested Relationship record. Default: `id(asc)`.")] = None,
        ...
        _param = self._related_contacts_index_serialize(
            matter_id=matter_id,
    ...
    @validate_call
    def related_contacts_index_with_http_info(
        self,
        matter_id: Annotated[StrictInt, Field(description="Filters RelatedContacts data by matter.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RelatedContactsList]:
        """Return the related contact data for a single matter
    ...
    @validate_call
    def related_contacts_index_without_preload_content(
        self,
        matter_id: Annotated[StrictInt, Field(description="Filters RelatedContacts data by matter.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    def _related_contacts_index_serialize(
        self,
        matter_id,
        x_api_version,
        fields,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/matters/{matter_id}/related_contacts.json',
