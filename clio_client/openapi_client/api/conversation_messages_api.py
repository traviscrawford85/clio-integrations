...
from clio_client.openapi_client.models.conversation_message_create_request import \
    ConversationMessageCreateRequest
from clio_client.openapi_client.models.conversation_message_list import \
    ConversationMessageList
from clio_client.openapi_client.models.conversation_message_show import \
...
class ConversationMessagesApi:
    ...
    def conversation_message_create(
        ...
        conversation_message_create_request: Annotated[Optional[ConversationMessageCreateRequest], Field(description="Request Body for Conversation Messages")] = None,
        ...
        _param = self._conversation_message_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            conversation_message_create_request=conversation_message_create_request,
    ...
    def conversation_message_create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConversationMessageShow]:
        """Create a new ConversationMessage
    ...
    @validate_call
    def conversation_message_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        conversation_message_create_request: Annotated[Optional[ConversationMessageCreateRequest], Field(description="Request Body for Conversation Messages")] = None,
    ...
    def _conversation_message_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if conversation_message_create_request is not None:
            _body_params = conversation_message_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/conversation_messages.json',
    ...
    @validate_call
    def conversation_message_index(
        self,
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter ConversationMessage records to those having the `created_at` field on the related Conversation after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter ConversationMessage records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of ConversationMessage records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the ConversationMessage records by the given field. Default: `id(asc)`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Wildcard search for `body` matching a given string.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter ConversationMessage records to those having the `updated_at` field on the related Conversation after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._conversation_message_index_serialize(
    ...
    @validate_call
    def conversation_message_index_without_preload_content(
        self,
        conversation_id: Annotated[StrictInt, Field(description="The unique identifier for a single Conversation. Use the keyword `null` to match those without a ConversationMessage. The list will be filtered to include only the ConversationMessage records with the matching property.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter ConversationMessage records to those having the `created_at` field on the related Conversation after a specific time. (Expects an ISO-8601 timestamp).")] = None,
    ...
    def _conversation_message_index_serialize(
        self,
        conversation_id,
        x_api_version,
        created_since,
    ...
    def conversation_message_show(
        ...
        _param = self._conversation_message_show_serialize(
            id=id,
    ...
    @validate_call
    def conversation_message_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the ConversationMessage.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _conversation_message_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/conversation_messages/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
