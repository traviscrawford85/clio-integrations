...
from clio_client.openapi_client.models.bill_update_request import \
...
class BillsApi:
    ...
    def bill_destroy(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Bill.")],
        ...
        _param = self._bill_destroy_serialize(
            id=id,
    ...
    @validate_call
    def bill_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Bill.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def bill_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Bill.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def bill_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        client_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. The keyword `null` is not valid for this field. The list will be filtered to include only the Bill records with the matching property.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter Bill records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        ...
        due_after: Annotated[Optional[date], Field(description="Filter Bill records to those that have a `due_date` after the one provided (Expects an ISO-8601 date).")] = None,
        due_at: Annotated[Optional[date], Field(description="Filter Bill records to those that have a specific `due_date` (Expects an ISO-8601 date).")] = None,
        due_before: Annotated[Optional[date], Field(description="Filter Bill records to those that have a `due_date` before the one provided (Expects an ISO-8601 date).")] = None,
        ...
        ids: Annotated[Optional[StrictInt], Field(description="Filter Bill records to those having the specified unique identifiers.")] = None,
        issued_after: Annotated[Optional[date], Field(description="Filter Bill records to those that have an `issue_date` after the one provided (Expects an ISO-8601 date).")] = None,
        issued_before: Annotated[Optional[date], Field(description="Filter Bill records to those that have an `issue_date` before the one provided (Expects an ISO-8601 date).")] = None,
        last_sent_end_date: Annotated[Optional[date], Field(description="Filter Bill records for those whose bills have been sent before the specified date")] = None,
        last_sent_start_date: Annotated[Optional[date], Field(description="Filter Bill records for those whose bills have been sent after the specified date")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of Bill records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        matter_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Matter. Use the keyword `null` to match those without a Bill. The list will be filtered to include only the Bill records with the matching property.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the Bill records by the given field. Default: `id(asc)`.")] = None,
        originating_attorney_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User. Use the keyword `null` to match those without a Bill. The list will be filtered to include only the Bill records with the matching property.")] = None,
        overdue_only: Annotated[Optional[StrictBool], Field(description="Filter Bill records to those that are overdue.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        query: Annotated[Optional[StrictInt], Field(description="Allows matching search on invoice number.")] = None,
        responsible_attorney_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User. Use the keyword `null` to match those without a Bill. The list will be filtered to include only the Bill records with the matching property.")] = None,
        state: Annotated[Optional[StrictStr], Field(description="Filter Bill records to those in a given state.")] = None,
        status: Annotated[Optional[StrictStr], Field(description="Filter Bill records to those with particular payment status.")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Filter Bill records to those of a specific type.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter Bill records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._bill_index_serialize(
            x_api_version=x_api_version,
            client_id=client_id,
    ...
    @validate_call
    def bill_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        client_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. The keyword `null` is not valid for this field. The list will be filtered to include only the Bill records with the matching property.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter Bill records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
    ...
    def _bill_index_serialize(
        ...
        if due_after is not None:
            if isinstance(due_after, date):
                ...
                _query_params.append(('due_after', due_after))
        ...
        if due_at is not None:
            if isinstance(due_at, date):
                ...
                _query_params.append(('due_at', due_at))
        ...
        if due_before is not None:
            if isinstance(due_before, date):
                ...
                _query_params.append(('due_before', due_before))
        ...
        if issued_after is not None:
            if isinstance(issued_after, date):
                _query_params.append(
                    (
                        'issued_after',
                ...
                _query_params.append(('issued_after', issued_after))
            
        if issued_before is not None:
            if isinstance(issued_before, date):
                _query_params.append(
                    (
                        'issued_before',
                ...
                _query_params.append(('issued_before', issued_before))
            
        if last_sent_end_date is not None:
            if isinstance(last_sent_end_date, date):
                _query_params.append(
                    (
                        'last_sent_end_date',
                        last_sent_end_date.strftime(
                            self.api_client.configuration.date_format
                        )
                    )
                )
            else:
                _query_params.append(('last_sent_end_date', last_sent_end_date))
            
        if last_sent_start_date is not None:
            if isinstance(last_sent_start_date, date):
                _query_params.append(
                    (
                        'last_sent_start_date',
                        last_sent_start_date.strftime(
                            self.api_client.configuration.date_format
                        )
                    )
                )
            else:
                _query_params.append(('last_sent_start_date', last_sent_start_date))
        ...
        if overdue_only is not None:
            ...
            _query_params.append(('overdue_only', overdue_only))
    ...
    def bill_preview(
        ...
        _param = self._bill_preview_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def bill_preview_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Bill.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bill_preview_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Bill.")],
        _request_timeout: Union[
            None,
    ...
    def _bill_preview_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/bills/{id}/preview.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def bill_show(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        navigation_next: Annotated[Optional[StrictInt], Field(description="The id of the next *Bill* available for viewing")] = None,
        navigation_previous: Annotated[Optional[StrictInt], Field(description="The id of the previous *Bill* available for viewing")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._bill_show_serialize(
            id=id,
    ...
    @validate_call
    def bill_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Bill.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _bill_show_serialize(
        ...
        if navigation_next is not None:
            
            _query_params.append(('navigation.next', navigation_next))
            
        if navigation_previous is not None:
            
            _query_params.append(('navigation.previous', navigation_previous))
    ...
    def bill_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        bill_update_request: Annotated[Optional[BillUpdateRequest], Field(description="Request Body for Bills")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._bill_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            bill_update_request=bill_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def bill_update_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Bill.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    @validate_call
    def bill_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Bill.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _bill_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if bill_update_request is not None:
            _body_params = bill_update_request
