...
from clio_client.openapi_client.models.jurisdiction_list import \
    JurisdictionList
from clio_client.openapi_client.models.jurisdiction_show import \
...
class JurisdictionsApi:
    ...
    def jurisdiction_index(
        ...
        created_since: Annotated[Optional[datetime], Field(description="Filter Jurisdiction records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        ...
        for_current_account: Annotated[Optional[StrictBool], Field(description="Filter Jurisdiction records to those set up for this account.")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter Jurisdiction records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of Jurisdiction records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the Jurisdiction records by the given field. Default: `id(asc)`.")] = None,
        ...
        updated_since: Annotated[Optional[datetime], Field(description="Filter Jurisdiction records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        ...
        _param = self._jurisdiction_index_serialize(
    ...
    @validate_call
    def jurisdiction_index_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter Jurisdiction records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    @validate_call
    def jurisdiction_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter Jurisdiction records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
    ...
    def _jurisdiction_index_serialize(
        self,
        x_api_version,
        created_since,
        fields,
        ...
        if for_current_account is not None:
            
            _query_params.append(('for_current_account', for_current_account))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/court_rules/jurisdictions.json',
    ...
    def jurisdiction_show(
        ...
        _param = self._jurisdiction_show_serialize(
            id=id,
    ...
    @validate_call
    def jurisdiction_show_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Jurisdiction.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    @validate_call
    def jurisdiction_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Jurisdiction.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _jurisdiction_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/court_rules/jurisdictions/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
