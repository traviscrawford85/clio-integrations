...
from clio_client.openapi_client.models.communication_create_request import \
    CommunicationCreateRequest
from clio_client.openapi_client.models.communication_list import \
    CommunicationList
from clio_client.openapi_client.models.communication_show import \
    CommunicationShow
from clio_client.openapi_client.models.communication_update_request import \
...
class CommunicationsApi:
    ...
    def communication_create(
        ...
        communication_create_request: Annotated[Optional[CommunicationCreateRequest], Field(description="Request Body for Communications")] = None,
        ...
        _param = self._communication_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            communication_create_request=communication_create_request,
    ...
    @validate_call
    def communication_create_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        communication_create_request: Annotated[Optional[CommunicationCreateRequest], Field(description="Request Body for Communications")] = None,
    ...
    @validate_call
    def communication_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        communication_create_request: Annotated[Optional[CommunicationCreateRequest], Field(description="Request Body for Communications")] = None,
    ...
    def _communication_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        if communication_create_request is not None:
            _body_params = communication_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/communications.json',
    ...
    def communication_destroy(
        ...
        _param = self._communication_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def communication_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Communication.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def communication_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Communication.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def _communication_destroy_serialize(
        self,
        id,
        x_api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/communications/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def communication_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. The keyword `null` is not valid for this field. The list will be filtered to include only the Communication records with the matching property.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter Communication records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        var_date: Annotated[Optional[date], Field(description="Filter Communication records to those that occur on the specified date (Expects an ISO-8601 date).")] = None,
        ...
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        having_time_entries: Annotated[Optional[StrictBool], Field(description="Filter Communication records to those that do or do not have time entries.")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter Communication records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of Communication records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        matter_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Matter. Use the keyword `null` to match those without a Communication. The list will be filtered to include only the Communication records with the matching property.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the Communication records by the given field. Default: `date(asc)`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Wildcard search for `body` or `subject` matching a given string.")] = None,
        received_at: Annotated[Optional[datetime], Field(description="Filter Communication records to those that occur on the specified date (Expects an ISO-8601 date-time).")] = None,
        received_before: Annotated[Optional[datetime], Field(description="Filter Communication records to those whose `date` is on or before the date provided (Expects an ISO-8601 date).")] = None,
        received_since: Annotated[Optional[datetime], Field(description="Filter Communication records to those whose `date` is on or after the date provided (Expects an ISO-8601 date).")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Filter Communication records to those of the specified type.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter Communication records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        user_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User. The keyword `null` is not valid for this field. The list will be filtered to include only the Communication records with the matching property.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._communication_index_serialize(
            x_api_version=x_api_version,
    ...
    @validate_call
    def communication_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. The keyword `null` is not valid for this field. The list will be filtered to include only the Communication records with the matching property.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter Communication records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
    ...
    def _communication_index_serialize(
        self,
        x_api_version,
        contact_id,
        created_since,
        ...
        if having_time_entries is not None:
            
            _query_params.append(('having_time_entries', having_time_entries))
        ...
        if received_at is not None:
            if isinstance(received_at, datetime):
                ...
                _query_params.append(('received_at', received_at))
        ...
        if received_before is not None:
            if isinstance(received_before, datetime):
                _query_params.append(
                    (
                        'received_before',
                        received_before.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('received_before', received_before))
            
        if received_since is not None:
            if isinstance(received_since, datetime):
                _query_params.append(
                    (
                        'received_since',
                        received_since.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('received_since', received_since))
    ...
    def communication_show(
        ...
        _param = self._communication_show_serialize(
            id=id,
    ...
    @validate_call
    def communication_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Communication.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _communication_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
    ...
    def communication_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        communication_update_request: Annotated[Optional[CommunicationUpdateRequest], Field(description="Request Body for Communications")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._communication_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            communication_update_request=communication_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def communication_update_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Communication.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    @validate_call
    def communication_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the Communication.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _communication_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
        ...
        # process the form parameters
        # process the body parameter
        if communication_update_request is not None:
            _body_params = communication_update_request
