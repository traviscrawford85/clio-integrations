...
class PhoneNumbersApi:
    ...
    def phone_number_index(
        ...
        created_since: Annotated[datetime | None, Field(description="Filter PhoneNumber records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        ...
        ids: Annotated[StrictInt | None, Field(description="Filter PhoneNumber records to those having the specified unique identifiers.")] = None,
        limit: Annotated[StrictInt | None, Field(description="A limit on the number of PhoneNumber records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        page_token: Annotated[StrictStr | None, Field(description="A token specifying which page to return.")] = None,
        updated_since: Annotated[datetime | None, Field(description="Filter PhoneNumber records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
