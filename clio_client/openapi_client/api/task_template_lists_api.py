...
from clio_client.openapi_client.models.task_template_list_copy_request import (
    TaskTemplateListCopyRequest,
)
from clio_client.openapi_client.models.task_template_list_create_request import (
    TaskTemplateListCreateRequest,
)
from clio_client.openapi_client.models.task_template_list_list import (
    TaskTemplateListList,
)
from clio_client.openapi_client.models.task_template_list_show import (
    TaskTemplateListShow,
)
from clio_client.openapi_client.models.task_template_list_update_request import (
    ApiResponse,
...
class TaskTemplateListsApi:
    ...
    def task_template_list_copy(
        ...
        task_template_list_copy_request: Annotated[Optional[TaskTemplateListCopyRequest], Field(description="Request Body for Task Template Lists")] = None,
        ...
        _param = self._task_template_list_copy_serialize(
            id=id,
            fields=fields,
            task_template_list_copy_request=task_template_list_copy_request,
    ...
    def task_template_list_copy_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaskTemplateListShow]:
        """Copy a TaskTemplateList
    ...
    @validate_call
    def task_template_list_copy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TaskTemplateList.")],
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        task_template_list_copy_request: Annotated[Optional[TaskTemplateListCopyRequest], Field(description="Request Body for Task Template Lists")] = None,
    ...
    def _task_template_list_copy_serialize(
        self,
        id,
        fields,
        ...
        if task_template_list_copy_request is not None:
            _body_params = task_template_list_copy_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/task_template_lists/{id}/copy.json',
    ...
    def task_template_list_create(
        ...
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        task_template_list_create_request: Annotated[Optional[TaskTemplateListCreateRequest], Field(description="Request Body for Task Template Lists")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._task_template_list_create_serialize(
            x_api_version=x_api_version,
            fields=fields,
            task_template_list_create_request=task_template_list_create_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def task_template_list_create_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        task_template_list_create_request: Annotated[Optional[TaskTemplateListCreateRequest], Field(description="Request Body for Task Template Lists")] = None,
    ...
    def _task_template_list_create_serialize(
        self,
        x_api_version,
        fields,
        ...
        # process the form parameters
        # process the body parameter
        if task_template_list_create_request is not None:
            _body_params = task_template_list_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/task_template_lists.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def task_template_list_destroy(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TaskTemplateList.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
        ...
        _param = self._task_template_list_destroy_serialize(
            id=id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def task_template_list_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TaskTemplateList.")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        _request_timeout: Union[
    ...
    def _task_template_list_destroy_serialize(
        self,
        id,
        x_api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/task_template_lists/{id}.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def task_template_list_index(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter TaskTemplateList records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        empty: Annotated[Optional[StrictBool], Field(description="Filter TaskTemplateList records to those that either contain at least one task template or contain none.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        ids: Annotated[Optional[StrictInt], Field(description="Filter TaskTemplateList records to those having the specified unique identifiers.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of TaskTemplateList records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Orders the TaskTemplateList records by the given field. Default: `id(asc)`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None,
        practice_area_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single PracticeArea. Use the keyword `null` to match those without a TaskTemplateList. The list will be filtered to include only the TaskTemplateList records with the matching property.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Wildcard search for `name` matching a given string.")] = None,
        updated_since: Annotated[Optional[datetime], Field(description="Filter TaskTemplateList records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._task_template_list_index_serialize(
            x_api_version=x_api_version,
    ...
    @validate_call
    def task_template_list_index_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter TaskTemplateList records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        empty: Annotated[Optional[StrictBool], Field(description="Filter TaskTemplateList records to those that either contain at least one task template or contain none.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaskTemplateListList]:
        """Return the data for all TaskTemplateLists
    ...
    @validate_call
    def task_template_list_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        created_since: Annotated[Optional[datetime], Field(description="Filter TaskTemplateList records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None,
        empty: Annotated[Optional[StrictBool], Field(description="Filter TaskTemplateList records to those that either contain at least one task template or contain none.")] = None,
    ...
    def _task_template_list_index_serialize(
        self,
        x_api_version,
        created_since,
        empty,
        ...
        if empty is not None:
            ...
            _query_params.append(('empty', empty))
    ...
    def task_template_list_show(
        ...
        _param = self._task_template_list_show_serialize(
            id=id,
    ...
    @validate_call
    def task_template_list_show_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TaskTemplateList.")],
        if_modified_since: Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None,
        if_none_match: Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None,
    ...
    def _task_template_list_show_serialize(
        self,
        id,
        if_modified_since,
        if_none_match,
    ...
    def task_template_list_update(
        ...
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None,
        task_template_list_update_request: Annotated[Optional[TaskTemplateListUpdateRequest], Field(description="Request Body for Task Template Lists")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._task_template_list_update_serialize(
            id=id,
            if_match=if_match,
            x_api_version=x_api_version,
            fields=fields,
            task_template_list_update_request=task_template_list_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def task_template_list_update_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TaskTemplateList.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    @validate_call
    def task_template_list_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the TaskTemplateList.")],
        if_match: Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _task_template_list_update_serialize(
        self,
        id,
        if_match,
        x_api_version,
        ...
        # process the form parameters
        # process the body parameter
        if task_template_list_update_request is not None:
            _body_params = task_template_list_update_request
